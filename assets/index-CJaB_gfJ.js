 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fg;function KS(){if(Fg)return ft;Fg=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),v=Symbol.iterator;function y(F){return F===null||typeof F!="object"?null:(F=v&&F[v]||F["@@iterator"],typeof F=="function"?F:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,M={};function x(F,ie,_e){this.props=F,this.context=ie,this.refs=M,this.updater=_e||b}x.prototype.isReactComponent={},x.prototype.setState=function(F,ie){if(typeof F!="object"&&typeof F!="function"&&F!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,F,ie,"setState")},x.prototype.forceUpdate=function(F){this.updater.enqueueForceUpdate(this,F,"forceUpdate")};function I(){}I.prototype=x.prototype;function U(F,ie,_e){this.props=F,this.context=ie,this.refs=M,this.updater=_e||b}var N=U.prototype=new I;N.constructor=U,T(N,x.prototype),N.isPureReactComponent=!0;var D=Array.isArray;function O(){}var L={H:null,A:null,T:null,S:null},z=Object.prototype.hasOwnProperty;function A(F,ie,_e){var de=_e.ref;return{$$typeof:s,type:F,key:ie,ref:de!==void 0?de:null,props:_e}}function C(F,ie){return A(F.type,ie,F.props)}function H(F){return typeof F=="object"&&F!==null&&F.$$typeof===s}function J(F){var ie={"=":"=0",":":"=2"};return"$"+F.replace(/[=:]/g,function(_e){return ie[_e]})}var q=/\/+/g;function ne(F,ie){return typeof F=="object"&&F!==null&&F.key!=null?J(""+F.key):ie.toString(36)}function $(F){switch(F.status){case"fulfilled":return F.value;case"rejected":throw F.reason;default:switch(typeof F.status=="string"?F.then(O,O):(F.status="pending",F.then(function(ie){F.status==="pending"&&(F.status="fulfilled",F.value=ie)},function(ie){F.status==="pending"&&(F.status="rejected",F.reason=ie)})),F.status){case"fulfilled":return F.value;case"rejected":throw F.reason}}throw F}function B(F,ie,_e,de,be){var Q=typeof F;(Q==="undefined"||Q==="boolean")&&(F=null);var ae=!1;if(F===null)ae=!0;else switch(Q){case"bigint":case"string":case"number":ae=!0;break;case"object":switch(F.$$typeof){case s:case t:ae=!0;break;case _:return ae=F._init,B(ae(F._payload),ie,_e,de,be)}}if(ae)return be=be(F),ae=de===""?"."+ne(F,0):de,D(be)?(_e="",ae!=null&&(_e=ae.replace(q,"$&/")+"/"),B(be,ie,_e,"",function(Ge){return Ge})):be!=null&&(H(be)&&(be=C(be,_e+(be.key==null||F&&F.key===be.key?"":(""+be.key).replace(q,"$&/")+"/")+ae)),ie.push(be)),1;ae=0;var Ae=de===""?".":de+":";if(D(F))for(var He=0;He<F.length;He++)de=F[He],Q=Ae+ne(de,He),ae+=B(de,ie,_e,Q,be);else if(He=y(F),typeof He=="function")for(F=He.call(F),He=0;!(de=F.next()).done;)de=de.value,Q=Ae+ne(de,He++),ae+=B(de,ie,_e,Q,be);else if(Q==="object"){if(typeof F.then=="function")return B($(F),ie,_e,de,be);throw ie=String(F),Error("Objects are not valid as a React child (found: "+(ie==="[object Object]"?"object with keys {"+Object.keys(F).join(", ")+"}":ie)+"). If you meant to render a collection of children, use an array instead.")}return ae}function G(F,ie,_e){if(F==null)return F;var de=[],be=0;return B(F,de,"","",function(Q){return ie.call(_e,Q,be++)}),de}function te(F){if(F._status===-1){var ie=F._result;ie=ie(),ie.then(function(_e){(F._status===0||F._status===-1)&&(F._status=1,F._result=_e)},function(_e){(F._status===0||F._status===-1)&&(F._status=2,F._result=_e)}),F._status===-1&&(F._status=0,F._result=ie)}if(F._status===1)return F._result.default;throw F._result}var ve=typeof reportError=="function"?reportError:function(F){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var ie=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof F=="object"&&F!==null&&typeof F.message=="string"?String(F.message):String(F),error:F});if(!window.dispatchEvent(ie))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",F);return}console.error(F)},ge={map:G,forEach:function(F,ie,_e){G(F,function(){ie.apply(this,arguments)},_e)},count:function(F){var ie=0;return G(F,function(){ie++}),ie},toArray:function(F){return G(F,function(ie){return ie})||[]},only:function(F){if(!H(F))throw Error("React.Children.only expected to receive a single React element child.");return F}};return ft.Activity=g,ft.Children=ge,ft.Component=x,ft.Fragment=i,ft.Profiler=l,ft.PureComponent=U,ft.StrictMode=r,ft.Suspense=m,ft.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,ft.__COMPILER_RUNTIME={__proto__:null,c:function(F){return L.H.useMemoCache(F)}},ft.cache=function(F){return function(){return F.apply(null,arguments)}},ft.cacheSignal=function(){return null},ft.cloneElement=function(F,ie,_e){if(F==null)throw Error("The argument must be a React element, but you passed "+F+".");var de=T({},F.props),be=F.key;if(ie!=null)for(Q in ie.key!==void 0&&(be=""+ie.key),ie)!z.call(ie,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&ie.ref===void 0||(de[Q]=ie[Q]);var Q=arguments.length-2;if(Q===1)de.children=_e;else if(1<Q){for(var ae=Array(Q),Ae=0;Ae<Q;Ae++)ae[Ae]=arguments[Ae+2];de.children=ae}return A(F.type,be,de)},ft.createContext=function(F){return F={$$typeof:d,_currentValue:F,_currentValue2:F,_threadCount:0,Provider:null,Consumer:null},F.Provider=F,F.Consumer={$$typeof:c,_context:F},F},ft.createElement=function(F,ie,_e){var de,be={},Q=null;if(ie!=null)for(de in ie.key!==void 0&&(Q=""+ie.key),ie)z.call(ie,de)&&de!=="key"&&de!=="__self"&&de!=="__source"&&(be[de]=ie[de]);var ae=arguments.length-2;if(ae===1)be.children=_e;else if(1<ae){for(var Ae=Array(ae),He=0;He<ae;He++)Ae[He]=arguments[He+2];be.children=Ae}if(F&&F.defaultProps)for(de in ae=F.defaultProps,ae)be[de]===void 0&&(be[de]=ae[de]);return A(F,Q,be)},ft.createRef=function(){return{current:null}},ft.forwardRef=function(F){return{$$typeof:h,render:F}},ft.isValidElement=H,ft.lazy=function(F){return{$$typeof:_,_payload:{_status:-1,_result:F},_init:te}},ft.memo=function(F,ie){return{$$typeof:p,type:F,compare:ie===void 0?null:ie}},ft.startTransition=function(F){var ie=L.T,_e={};L.T=_e;try{var de=F(),be=L.S;be!==null&&be(_e,de),typeof de=="object"&&de!==null&&typeof de.then=="function"&&de.then(O,ve)}catch(Q){ve(Q)}finally{ie!==null&&_e.types!==null&&(ie.types=_e.types),L.T=ie}},ft.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},ft.use=function(F){return L.H.use(F)},ft.useActionState=function(F,ie,_e){return L.H.useActionState(F,ie,_e)},ft.useCallback=function(F,ie){return L.H.useCallback(F,ie)},ft.useContext=function(F){return L.H.useContext(F)},ft.useDebugValue=function(){},ft.useDeferredValue=function(F,ie){return L.H.useDeferredValue(F,ie)},ft.useEffect=function(F,ie){return L.H.useEffect(F,ie)},ft.useEffectEvent=function(F){return L.H.useEffectEvent(F)},ft.useId=function(){return L.H.useId()},ft.useImperativeHandle=function(F,ie,_e){return L.H.useImperativeHandle(F,ie,_e)},ft.useInsertionEffect=function(F,ie){return L.H.useInsertionEffect(F,ie)},ft.useLayoutEffect=function(F,ie){return L.H.useLayoutEffect(F,ie)},ft.useMemo=function(F,ie){return L.H.useMemo(F,ie)},ft.useOptimistic=function(F,ie){return L.H.useOptimistic(F,ie)},ft.useReducer=function(F,ie,_e){return L.H.useReducer(F,ie,_e)},ft.useRef=function(F){return L.H.useRef(F)},ft.useState=function(F){return L.H.useState(F)},ft.useSyncExternalStore=function(F,ie,_e){return L.H.useSyncExternalStore(F,ie,_e)},ft.useTransition=function(){return L.H.useTransition()},ft.version="19.2.4",ft}var Ig;function Vh(){return Ig||(Ig=1,sd.exports=KS()),sd.exports}var Be=Vh();const QS=nv(Be);var od={exports:{}},Io={},ld={exports:{}},cd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bg;function JS(){return Bg||(Bg=1,(function(s){function t(B,G){var te=B.length;B.push(G);e:for(;0<te;){var ve=te-1>>>1,ge=B[ve];if(0<l(ge,G))B[ve]=G,B[te]=ge,te=ve;else break e}}function i(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var G=B[0],te=B.pop();if(te!==G){B[0]=te;e:for(var ve=0,ge=B.length,F=ge>>>1;ve<F;){var ie=2*(ve+1)-1,_e=B[ie],de=ie+1,be=B[de];if(0>l(_e,te))de<ge&&0>l(be,_e)?(B[ve]=be,B[de]=te,ve=de):(B[ve]=_e,B[ie]=te,ve=ie);else if(de<ge&&0>l(be,te))B[ve]=be,B[de]=te,ve=de;else break e}}return G}function l(B,G){var te=B.sortIndex-G.sortIndex;return te!==0?te:B.id-G.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var d=Date,h=d.now();s.unstable_now=function(){return d.now()-h}}var m=[],p=[],_=1,g=null,v=3,y=!1,b=!1,T=!1,M=!1,x=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function N(B){for(var G=i(p);G!==null;){if(G.callback===null)r(p);else if(G.startTime<=B)r(p),G.sortIndex=G.expirationTime,t(m,G);else break;G=i(p)}}function D(B){if(T=!1,N(B),!b)if(i(m)!==null)b=!0,O||(O=!0,J());else{var G=i(p);G!==null&&$(D,G.startTime-B)}}var O=!1,L=-1,z=5,A=-1;function C(){return M?!0:!(s.unstable_now()-A<z)}function H(){if(M=!1,O){var B=s.unstable_now();A=B;var G=!0;try{e:{b=!1,T&&(T=!1,I(L),L=-1),y=!0;var te=v;try{t:{for(N(B),g=i(m);g!==null&&!(g.expirationTime>B&&C());){var ve=g.callback;if(typeof ve=="function"){g.callback=null,v=g.priorityLevel;var ge=ve(g.expirationTime<=B);if(B=s.unstable_now(),typeof ge=="function"){g.callback=ge,N(B),G=!0;break t}g===i(m)&&r(m),N(B)}else r(m);g=i(m)}if(g!==null)G=!0;else{var F=i(p);F!==null&&$(D,F.startTime-B),G=!1}}break e}finally{g=null,v=te,y=!1}G=void 0}}finally{G?J():O=!1}}}var J;if(typeof U=="function")J=function(){U(H)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,ne=q.port2;q.port1.onmessage=H,J=function(){ne.postMessage(null)}}else J=function(){x(H,0)};function $(B,G){L=x(function(){B(s.unstable_now())},G)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(B){B.callback=null},s.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<B?Math.floor(1e3/B):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_next=function(B){switch(v){case 1:case 2:case 3:var G=3;break;default:G=v}var te=v;v=G;try{return B()}finally{v=te}},s.unstable_requestPaint=function(){M=!0},s.unstable_runWithPriority=function(B,G){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var te=v;v=B;try{return G()}finally{v=te}},s.unstable_scheduleCallback=function(B,G,te){var ve=s.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?ve+te:ve):te=ve,B){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=te+ge,B={id:_++,callback:G,priorityLevel:B,startTime:te,expirationTime:ge,sortIndex:-1},te>ve?(B.sortIndex=te,t(p,B),i(m)===null&&B===i(p)&&(T?(I(L),L=-1):T=!0,$(D,te-ve))):(B.sortIndex=ge,t(m,B),b||y||(b=!0,O||(O=!0,J()))),B},s.unstable_shouldYield=C,s.unstable_wrapCallback=function(B){var G=v;return function(){var te=v;v=G;try{return B.apply(this,arguments)}finally{v=te}}}})(cd)),cd}var zg;function $S(){return zg||(zg=1,ld.exports=JS()),ld.exports}var ud={exports:{}},Ln={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Vg;function ny(){if(Vg)return Io;Vg=1;var s=$S(),t=Vh(),i=ty();function r(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function d(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function h(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(c(e)!==e)throw Error(r(188))}function p(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(r(188));return n!==e?null:e}for(var a=e,o=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return m(u),e;if(f===o)return m(u),n;f=f.sibling}throw Error(r(188))}if(a.return!==o.return)a=u,o=f;else{for(var S=!1,R=u.child;R;){if(R===a){S=!0,a=u,o=f;break}if(R===o){S=!0,o=u,a=f;break}R=R.sibling}if(!S){for(R=f.child;R;){if(R===a){S=!0,a=f,o=u;break}if(R===o){S=!0,o=f,a=u;break}R=R.sibling}if(!S)throw Error(r(189))}}if(a.alternate!==o)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?e:n}function _(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=_(e),n!==null)return n;e=e.sibling}return null}var g=Object.assign,v=Symbol.for("react.element"),y=Symbol.for("react.transitional.element"),b=Symbol.for("react.portal"),T=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),I=Symbol.for("react.consumer"),U=Symbol.for("react.context"),N=Symbol.for("react.forward_ref"),D=Symbol.for("react.suspense"),O=Symbol.for("react.suspense_list"),L=Symbol.for("react.memo"),z=Symbol.for("react.lazy"),A=Symbol.for("react.activity"),C=Symbol.for("react.memo_cache_sentinel"),H=Symbol.iterator;function J(e){return e===null||typeof e!="object"?null:(e=H&&e[H]||e["@@iterator"],typeof e=="function"?e:null)}var q=Symbol.for("react.client.reference");function ne(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===q?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case T:return"Fragment";case x:return"Profiler";case M:return"StrictMode";case D:return"Suspense";case O:return"SuspenseList";case A:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case b:return"Portal";case U:return e.displayName||"Context";case I:return(e._context.displayName||"Context")+".Consumer";case N:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case L:return n=e.displayName||null,n!==null?n:ne(e.type)||"Memo";case z:n=e._payload,e=e._init;try{return ne(e(n))}catch{}}return null}var $=Array.isArray,B=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,te={pending:!1,data:null,method:null,action:null},ve=[],ge=-1;function F(e){return{current:e}}function ie(e){0>ge||(e.current=ve[ge],ve[ge]=null,ge--)}function _e(e,n){ge++,ve[ge]=e.current,e.current=n}var de=F(null),be=F(null),Q=F(null),ae=F(null);function Ae(e,n){switch(_e(Q,n),_e(be,e),_e(de,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?ig(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=ig(n),e=ag(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}ie(de),_e(de,e)}function He(){ie(de),ie(be),ie(Q)}function Ge(e){e.memoizedState!==null&&_e(ae,e);var n=de.current,a=ag(n,e.type);n!==a&&(_e(be,e),_e(de,a))}function ct(e){be.current===e&&(ie(de),ie(be)),ae.current===e&&(ie(ae),No._currentValue=te)}var Yt,pt;function mt(e){if(Yt===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Yt=n&&n[1]||"",pt=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Yt+e+pt}var st=!1;function Ke(e,n){if(!e||st)return"";st=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var Se=function(){throw Error()};if(Object.defineProperty(Se.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(Se,[])}catch(fe){var le=fe}Reflect.construct(e,[],Se)}else{try{Se.call()}catch(fe){le=fe}e.call(Se.prototype)}}else{try{throw Error()}catch(fe){le=fe}(Se=e())&&typeof Se.catch=="function"&&Se.catch(function(){})}}catch(fe){if(fe&&le&&typeof fe.stack=="string")return[fe.stack,le.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=o.DetermineComponentFrameRoot(),S=f[0],R=f[1];if(S&&R){var V=S.split(`
`),se=R.split(`
...
`].filter(Qo).join(`
`)),d=Hh(d),d=N_(d,i),d=L_(d,i),h=Hh(h),h=N_(h,i),h=L_(h,i),d=O_(d),h=O_(h),i.isRawShaderMaterial!==!0&&(I=`#version 300 es
...
`)+`
`+x);const U=I+M+d,N=I+x+h,D=w_(l,l.VERTEX_SHADER,U),O=w_(l,l.FRAGMENT_SHADER,N);l.attachShader(T,D),l.attachShader(T,O),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function L(H){if(s.debug.checkShaderErrors){const J=l.getProgramInfoLog(T)||"",q=l.getShaderInfoLog(D)||"",ne=l.getShaderInfoLog(O)||"",$=J.trim(),B=q.trim(),G=ne.trim();let te=!0,ve=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(te=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,T,D,O);else{const ge=U_(l,D,"vertex"),F=U_(l,O,"fragment");Ut("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
...
}`,rA=[new ce(1,0,0),new ce(-1,0,0),new ce(0,1,0),new ce(0,-1,0),new ce(0,0,1),new ce(0,0,-1)],sA=[new ce(0,-1,0),new ce(0,-1,0),new ce(0,0,1),new ce(0,0,-1),new ce(0,-1,0),new ce(0,-1,0)],z_=new hn,Xo=new ce,Vd=new ce;function oA(s,t,i){let r=new Uv;const l=new Nt,c=new Nt,d=new rn,h=new vM,m=new xM,p={},_=i.maxTextureSize,g={[ar]:Wn,[Wn]:ar,[Ii]:Ii},v=new gi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:iA,fragmentShader:aA}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const b=new Ma;b.setAttribute("position",new Vi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new wi(b,v),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vc;let x=this.type;this.render=function(O,L,z){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||O.length===0)return;O.type===ly&&(dt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),O.type=Vc);const A=s.getRenderTarget(),C=s.getActiveCubeFace(),H=s.getActiveMipmapLevel(),J=s.state;J.setBlending(ma),J.buffers.depth.getReversed()===!0?J.buffers.color.setClear(0,0,0,0):J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const q=x!==this.type;q&&L.traverse(function(ne){ne.material&&(Array.isArray(ne.material)?ne.material.forEach($=>$.needsUpdate=!0):ne.material.needsUpdate=!0)});for(let ne=0,$=O.length;ne<$;ne++){const B=O[ne],G=B.shadow;if(G===void 0){dt("WebGLShadowMap:",B,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;l.copy(G.mapSize);const te=G.getFrameExtents();if(l.multiply(te),c.copy(G.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(c.x=Math.floor(_/te.x),l.x=c.x*te.x,G.mapSize.x=c.x),l.y>_&&(c.y=Math.floor(_/te.y),l.y=c.y*te.y,G.mapSize.y=c.y)),G.map===null||q===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Zo){if(B.isPointLight){dt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Gi(l.x,l.y,{format:Is,type:xa,minFilter:dn,magFilter:dn,generateMipmaps:!1}),G.map.texture.name=B.name+".shadowMap",G.map.depthTexture=new il(l.x,l.y,Bi),G.map.depthTexture.name=B.name+".shadowMapDepth",G.map.depthTexture.format=Sa,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Dn,G.map.depthTexture.magFilter=Dn}else{B.isPointLight?(G.map=new wv(l.x),G.map.depthTexture=new gM(l.x,ki)):(G.map=new Gi(l.x,l.y),G.map.depthTexture=new il(l.x,l.y,ki)),G.map.depthTexture.name=B.name+".shadowMap",G.map.depthTexture.format=Sa;const ge=s.state.buffers.depth.getReversed();this.type===Vc?(G.map.depthTexture.compareFunction=ge?Qh:Kh,G.map.depthTexture.minFilter=dn,G.map.depthTexture.magFilter=dn):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Dn,G.map.depthTexture.magFilter=Dn)}G.camera.updateProjectionMatrix()}const ve=G.map.isWebGLCubeRenderTarget?6:1;for(let ge=0;ge<ve;ge++){if(G.map.isWebGLCubeRenderTarget)s.setRenderTarget(G.map,ge),s.clear();else{ge===0&&(s.setRenderTarget(G.map),s.clear());const F=G.getViewport(ge);d.set(c.x*F.x,c.y*F.y,c.x*F.z,c.y*F.w),J.viewport(d)}if(B.isPointLight){const F=G.camera,ie=G.matrix,_e=B.distance||F.far;_e!==F.far&&(F.far=_e,F.updateProjectionMatrix()),Xo.setFromMatrixPosition(B.matrixWorld),F.position.copy(Xo),Vd.copy(F.position),Vd.add(rA[ge]),F.up.copy(sA[ge]),F.lookAt(Vd),F.updateMatrixWorld(),ie.makeTranslation(-Xo.x,-Xo.y,-Xo.z),z_.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),G._frustum.setFromProjectionMatrix(z_,F.coordinateSystem,F.reversedDepth)}else G.updateMatrices(B);r=G.getFrustum(),N(L,z,G.camera,B,this.type)}G.isPointLightShadow!==!0&&this.type===Zo&&I(G,z),G.needsUpdate=!1}x=this.type,M.needsUpdate=!1,s.setRenderTarget(A,C,H)};function I(O,L){const z=t.update(T);v.defines.VSM_SAMPLES!==O.blurSamples&&(v.defines.VSM_SAMPLES=O.blurSamples,y.defines.VSM_SAMPLES=O.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new Gi(l.x,l.y,{format:Is,type:xa})),v.uniforms.shadow_pass.value=O.map.depthTexture,v.uniforms.resolution.value=O.mapSize,v.uniforms.radius.value=O.radius,s.setRenderTarget(O.mapPass),s.clear(),s.renderBufferDirect(L,null,z,v,T,null),y.uniforms.shadow_pass.value=O.mapPass.texture,y.uniforms.resolution.value=O.mapSize,y.uniforms.radius.value=O.radius,s.setRenderTarget(O.map),s.clear(),s.renderBufferDirect(L,null,z,y,T,null)}function U(O,L,z,A){let C=null;const H=z.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(H!==void 0)C=H;else if(C=z.isPointLight===!0?m:h,s.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const J=C.uuid,q=L.uuid;let ne=p[J];ne===void 0&&(ne={},p[J]=ne);let $=ne[q];$===void 0&&($=C.clone(),ne[q]=$,L.addEventListener("dispose",D)),C=$}if(C.visible=L.visible,C.wireframe=L.wireframe,A===Zo?C.side=L.shadowSide!==null?L.shadowSide:L.side:C.side=L.shadowSide!==null?L.shadowSide:g[L.side],C.alphaMap=L.alphaMap,C.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,C.map=L.map,C.clipShadows=L.clipShadows,C.clippingPlanes=L.clippingPlanes,C.clipIntersection=L.clipIntersection,C.displacementMap=L.displacementMap,C.displacementScale=L.displacementScale,C.displacementBias=L.displacementBias,C.wireframeLinewidth=L.wireframeLinewidth,C.linewidth=L.linewidth,z.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const J=s.properties.get(C);J.light=z}return C}function N(O,L,z,A,C){if(O.visible===!1)return;if(O.layers.test(L.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&C===Zo)&&(!O.frustumCulled||r.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,O.matrixWorld);const q=t.update(O),ne=O.material;if(Array.isArray(ne)){const $=q.groups;for(let B=0,G=$.length;B<G;B++){const te=$[B],ve=ne[te.materialIndex];if(ve&&ve.visible){const ge=U(O,ve,A,C);O.onBeforeShadow(s,O,L,z,q,ge,te),s.renderBufferDirect(z,null,q,ge,O,te),O.onAfterShadow(s,O,L,z,q,ge,te)}}}else if(ne.visible){const $=U(O,ne,A,C);O.onBeforeShadow(s,O,L,z,q,$,null),s.renderBufferDirect(z,null,q,$,O,null),O.onAfterShadow(s,O,L,z,q,$,null)}}const J=O.children;for(let q=0,ne=J.length;q<ne;q++)N(J[q],L,z,A,C)}function D(O){O.target.removeEventListener("dispose",D);for(const z in p){const A=p[z],C=O.target.uuid;C in A&&(A[C].dispose(),delete A[C])}}}const lA={[Zd]:Kd,[Qd]:eh,[Jd]:th,[Ps]:$d,[Kd]:Zd,[eh]:Qd,[th]:Jd,[$d]:Ps};function cA(s,t){function i(){let Y=!1;const Le=new rn;let De=null;const ze=new rn(0,0,0,0);return{setMask:function(Te){De!==Te&&!Y&&(s.colorMask(Te,Te,Te,Te),De=Te)},setLocked:function(Te){Y=Te},setClear:function(Te,Me,Ue,ot,It){It===!0&&(Te*=ot,Me*=ot,Ue*=ot),Le.set(Te,Me,Ue,ot),ze.equals(Le)===!1&&(s.clearColor(Te,Me,Ue,ot),ze.copy(Le))},reset:function(){Y=!1,De=null,ze.set(-1,0,0,0)}}}function r(){let Y=!1,Le=!1,De=null,ze=null,Te=null;return{setReversed:function(Me){if(Le!==Me){const Ue=t.get("EXT_clip_control");Me?Ue.clipControlEXT(Ue.LOWER_LEFT_EXT,Ue.ZERO_TO_ONE_EXT):Ue.clipControlEXT(Ue.LOWER_LEFT_EXT,Ue.NEGATIVE_ONE_TO_ONE_EXT),Le=Me;const ot=Te;Te=null,this.setClear(ot)}},getReversed:function(){return Le},setTest:function(Me){Me?ae(s.DEPTH_TEST):Ae(s.DEPTH_TEST)},setMask:function(Me){De!==Me&&!Y&&(s.depthMask(Me),De=Me)},setFunc:function(Me){if(Le&&(Me=lA[Me]),ze!==Me){switch(Me){case Zd:s.depthFunc(s.NEVER);break;case Kd:s.depthFunc(s.ALWAYS);break;case Qd:s.depthFunc(s.LESS);break;case Ps:s.depthFunc(s.LEQUAL);break;case Jd:s.depthFunc(s.EQUAL);break;case $d:s.depthFunc(s.GEQUAL);break;case eh:s.depthFunc(s.GREATER);break;case th:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}ze=Me}},setLocked:function(Me){Y=Me},setClear:function(Me){Te!==Me&&(Le&&(Me=1-Me),s.clearDepth(Me),Te=Me)},reset:function(){Y=!1,De=null,ze=null,Te=null,Le=!1}}}function l(){let Y=!1,Le=null,De=null,ze=null,Te=null,Me=null,Ue=null,ot=null,It=null;return{setTest:function(Rt){Y||(Rt?ae(s.STENCIL_TEST):Ae(s.STENCIL_TEST))},setMask:function(Rt){Le!==Rt&&!Y&&(s.stencilMask(Rt),Le=Rt)},setFunc:function(Rt,Nn,_i){(De!==Rt||ze!==Nn||Te!==_i)&&(s.stencilFunc(Rt,Nn,_i),De=Rt,ze=Nn,Te=_i)},setOp:function(Rt,Nn,_i){(Me!==Rt||Ue!==Nn||ot!==_i)&&(s.stencilOp(Rt,Nn,_i),Me=Rt,Ue=Nn,ot=_i)},setLocked:function(Rt){Y=Rt},setClear:function(Rt){It!==Rt&&(s.clearStencil(Rt),It=Rt)},reset:function(){Y=!1,Le=null,De=null,ze=null,Te=null,Me=null,Ue=null,ot=null,It=null}}}const c=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let _={},g={},v=new WeakMap,y=[],b=null,T=!1,M=null,x=null,I=null,U=null,N=null,D=null,O=null,L=new Wt(0,0,0),z=0,A=!1,C=null,H=null,J=null,q=null,ne=null;const $=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,G=0;const te=s.getParameter(s.VERSION);te.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(te)[1]),B=G>=1):te.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),B=G>=2);let ve=null,ge={};const F=s.getParameter(s.SCISSOR_BOX),ie=s.getParameter(s.VIEWPORT),_e=new rn().fromArray(F),de=new rn().fromArray(ie);function be(Y,Le,De,ze){const Te=new Uint8Array(4),Me=s.createTexture();s.bindTexture(Y,Me),s.texParameteri(Y,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(Y,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ue=0;Ue<De;Ue++)Y===s.TEXTURE_3D||Y===s.TEXTURE_2D_ARRAY?s.texImage3D(Le,0,s.RGBA,1,1,ze,0,s.RGBA,s.UNSIGNED_BYTE,Te):s.texImage2D(Le+Ue,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Te);return Me}const Q={};Q[s.TEXTURE_2D]=be(s.TEXTURE_2D,s.TEXTURE_2D,1),Q[s.TEXTURE_CUBE_MAP]=be(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[s.TEXTURE_2D_ARRAY]=be(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Q[s.TEXTURE_3D]=be(s.TEXTURE_3D,s.TEXTURE_3D,1,1),c.setClear(0,0,0,1),d.setClear(1),h.setClear(0),ae(s.DEPTH_TEST),d.setFunc(Ps),Ke(!1),et(Xg),ae(s.CULL_FACE),mt(ma);function ae(Y){_[Y]!==!0&&(s.enable(Y),_[Y]=!0)}function Ae(Y){_[Y]!==!1&&(s.disable(Y),_[Y]=!1)}function He(Y,Le){return g[Y]!==Le?(s.bindFramebuffer(Y,Le),g[Y]=Le,Y===s.DRAW_FRAMEBUFFER&&(g[s.FRAMEBUFFER]=Le),Y===s.FRAMEBUFFER&&(g[s.DRAW_FRAMEBUFFER]=Le),!0):!1}function Ge(Y,Le){let De=y,ze=!1;if(Y){De=v.get(Le),De===void 0&&(De=[],v.set(Le,De));const Te=Y.textures;if(De.length!==Te.length||De[0]!==s.COLOR_ATTACHMENT0){for(let Me=0,Ue=Te.length;Me<Ue;Me++)De[Me]=s.COLOR_ATTACHMENT0+Me;De.length=Te.length,ze=!0}}else De[0]!==s.BACK&&(De[0]=s.BACK,ze=!0);ze&&s.drawBuffers(De)}function ct(Y){return b!==Y?(s.useProgram(Y),b=Y,!0):!1}const Yt={[Dr]:s.FUNC_ADD,[uy]:s.FUNC_SUBTRACT,[fy]:s.FUNC_REVERSE_SUBTRACT};Yt[dy]=s.MIN,Yt[hy]=s.MAX;const pt={[py]:s.ZERO,[my]:s.ONE,[gy]:s.SRC_COLOR,[Yd]:s.SRC_ALPHA,[My]:s.SRC_ALPHA_SATURATE,[Sy]:s.DST_COLOR,[vy]:s.DST_ALPHA,[_y]:s.ONE_MINUS_SRC_COLOR,[jd]:s.ONE_MINUS_SRC_ALPHA,[yy]:s.ONE_MINUS_DST_COLOR,[xy]:s.ONE_MINUS_DST_ALPHA,[Ey]:s.CONSTANT_COLOR,[by]:s.ONE_MINUS_CONSTANT_COLOR,[Ty]:s.CONSTANT_ALPHA,[Ay]:s.ONE_MINUS_CONSTANT_ALPHA};function mt(Y,Le,De,ze,Te,Me,Ue,ot,It,Rt){if(Y===ma){T===!0&&(Ae(s.BLEND),T=!1);return}if(T===!1&&(ae(s.BLEND),T=!0),Y!==cy){if(Y!==M||Rt!==A){if((x!==Dr||N!==Dr)&&(s.blendEquation(s.FUNC_ADD),x=Dr,N=Dr),Rt)switch(Y){case Ls:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Wg:s.blendFunc(s.ONE,s.ONE);break;case qg:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Yg:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Ut("WebGLState: Invalid blending: ",Y);break}else switch(Y){case Ls:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Wg:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case qg:Ut("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Yg:Ut("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ut("WebGLState: Invalid blending: ",Y);break}I=null,U=null,D=null,O=null,L.set(0,0,0),z=0,M=Y,A=Rt}return}Te=Te||Le,Me=Me||De,Ue=Ue||ze,(Le!==x||Te!==N)&&(s.blendEquationSeparate(Yt[Le],Yt[Te]),x=Le,N=Te),(De!==I||ze!==U||Me!==D||Ue!==O)&&(s.blendFuncSeparate(pt[De],pt[ze],pt[Me],pt[Ue]),I=De,U=ze,D=Me,O=Ue),(ot.equals(L)===!1||It!==z)&&(s.blendColor(ot.r,ot.g,ot.b,It),L.copy(ot),z=It),M=Y,A=!1}function st(Y,Le){Y.side===Ii?Ae(s.CULL_FACE):ae(s.CULL_FACE);let De=Y.side===Wn;Le&&(De=!De),Ke(De),Y.blending===Ls&&Y.transparent===!1?mt(ma):mt(Y.blending,Y.blendEquation,Y.blendSrc,Y.blendDst,Y.blendEquationAlpha,Y.blendSrcAlpha,Y.blendDstAlpha,Y.blendColor,Y.blendAlpha,Y.premultipliedAlpha),d.setFunc(Y.depthFunc),d.setTest(Y.depthTest),d.setMask(Y.depthWrite),c.setMask(Y.colorWrite);const ze=Y.stencilWrite;h.setTest(ze),ze&&(h.setMask(Y.stencilWriteMask),h.setFunc(Y.stencilFunc,Y.stencilRef,Y.stencilFuncMask),h.setOp(Y.stencilFail,Y.stencilZFail,Y.stencilZPass)),St(Y.polygonOffset,Y.polygonOffsetFactor,Y.polygonOffsetUnits),Y.alphaToCoverage===!0?ae(s.SAMPLE_ALPHA_TO_COVERAGE):Ae(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ke(Y){C!==Y&&(Y?s.frontFace(s.CW):s.frontFace(s.CCW),C=Y)}function et(Y){Y!==sy?(ae(s.CULL_FACE),Y!==H&&(Y===Xg?s.cullFace(s.BACK):Y===oy?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ae(s.CULL_FACE),H=Y}function k(Y){Y!==J&&(B&&s.lineWidth(Y),J=Y)}function St(Y,Le,De){Y?(ae(s.POLYGON_OFFSET_FILL),(q!==Le||ne!==De)&&(s.polygonOffset(Le,De),q=Le,ne=De)):Ae(s.POLYGON_OFFSET_FILL)}function Qe(Y){Y?ae(s.SCISSOR_TEST):Ae(s.SCISSOR_TEST)}function ut(Y){Y===void 0&&(Y=s.TEXTURE0+$-1),ve!==Y&&(s.activeTexture(Y),ve=Y)}function Ve(Y,Le,De){De===void 0&&(ve===null?De=s.TEXTURE0+$-1:De=ve);let ze=ge[De];ze===void 0&&(ze={type:void 0,texture:void 0},ge[De]=ze),(ze.type!==Y||ze.texture!==Le)&&(ve!==De&&(s.activeTexture(De),ve=De),s.bindTexture(Y,Le||Q[Y]),ze.type=Y,ze.texture=Le)}function P(){const Y=ge[ve];Y!==void 0&&Y.type!==void 0&&(s.bindTexture(Y.type,null),Y.type=void 0,Y.texture=void 0)}function E(){try{s.compressedTexImage2D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function W(){try{s.compressedTexImage3D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function pe(){try{s.texSubImage2D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function ye(){try{s.texSubImage3D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function he(){try{s.compressedTexSubImage2D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function ke(){try{s.compressedTexSubImage3D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function Re(){try{s.texStorage2D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function We(){try{s.texStorage3D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function nt(){try{s.texImage2D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function Ee(){try{s.texImage3D(...arguments)}catch(Y){Ut("WebGLState:",Y)}}function Ce(Y){_e.equals(Y)===!1&&(s.scissor(Y.x,Y.y,Y.z,Y.w),_e.copy(Y))}function Ie(Y){de.equals(Y)===!1&&(s.viewport(Y.x,Y.y,Y.z,Y.w),de.copy(Y))}function Pe(Y,Le){let De=p.get(Le);De===void 0&&(De=new WeakMap,p.set(Le,De));let ze=De.get(Y);ze===void 0&&(ze=s.getUniformBlockIndex(Le,Y.name),De.set(Y,ze))}function we(Y,Le){const ze=p.get(Le).get(Y);m.get(Le)!==ze&&(s.uniformBlockBinding(Le,ze,Y.__bindingPointIndex),m.set(Le,ze))}function gt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),d.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),_={},ve=null,ge={},g={},v=new WeakMap,y=[],b=null,T=!1,M=null,x=null,I=null,U=null,N=null,D=null,O=null,L=new Wt(0,0,0),z=0,A=!1,C=null,H=null,J=null,q=null,ne=null,_e.set(0,0,s.canvas.width,s.canvas.height),de.set(0,0,s.canvas.width,s.canvas.height),c.reset(),d.reset(),h.reset()}return{buffers:{color:c,depth:d,stencil:h},enable:ae,disable:Ae,bindFramebuffer:He,drawBuffers:Ge,useProgram:ct,setBlending:mt,setMaterial:st,setFlipSided:Ke,setCullFace:et,setLineWidth:k,setPolygonOffset:St,setScissorTest:Qe,activeTexture:ut,bindTexture:Ve,unbindTexture:P,compressedTexImage2D:E,compressedTexImage3D:W,texImage2D:nt,texImage3D:Ee,updateUBOMapping:Pe,uniformBlockBinding:we,texStorage2D:Re,texStorage3D:We,texSubImage2D:pe,texSubImage3D:ye,compressedTexSubImage2D:he,compressedTexSubImage3D:ke,scissor:Ce,viewport:Ie,reset:gt}}function uA(s,t,i,r,l,c,d){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Nt,_=new WeakMap;let g;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(P,E){return y?new OffscreenCanvas(P,E):tl("canvas")}function T(P,E,W){let pe=1;const ye=Ve(P);if((ye.width>W||ye.height>W)&&(pe=W/Math.max(ye.width,ye.height)),pe<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const he=Math.floor(pe*ye.width),ke=Math.floor(pe*ye.height);g===void 0&&(g=b(he,ke));const Re=E?b(he,ke):g;return Re.width=he,Re.height=ke,Re.getContext("2d").drawImage(P,0,0,he,ke),dt("WebGLRenderer: Texture has been resized from ("+ye.width+"x"+ye.height+") to ("+he+"x"+ke+")."),Re}else return"data"in P&&dt("WebGLRenderer: Image in DataTexture is too big ("+ye.width+"x"+ye.height+")."),P;return P}function M(P){return P.generateMipmaps}function x(P){s.generateMipmap(P)}function I(P){return P.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?s.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function U(P,E,W,pe,ye=!1){if(P!==null){if(s[P]!==void 0)return s[P];dt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let he=E;if(E===s.RED&&(W===s.FLOAT&&(he=s.R32F),W===s.HALF_FLOAT&&(he=s.R16F),W===s.UNSIGNED_BYTE&&(he=s.R8)),E===s.RED_INTEGER&&(W===s.UNSIGNED_BYTE&&(he=s.R8UI),W===s.UNSIGNED_SHORT&&(he=s.R16UI),W===s.UNSIGNED_INT&&(he=s.R32UI),W===s.BYTE&&(he=s.R8I),W===s.SHORT&&(he=s.R16I),W===s.INT&&(he=s.R32I)),E===s.RG&&(W===s.FLOAT&&(he=s.RG32F),W===s.HALF_FLOAT&&(he=s.RG16F),W===s.UNSIGNED_BYTE&&(he=s.RG8)),E===s.RG_INTEGER&&(W===s.UNSIGNED_BYTE&&(he=s.RG8UI),W===s.UNSIGNED_SHORT&&(he=s.RG16UI),W===s.UNSIGNED_INT&&(he=s.RG32UI),W===s.BYTE&&(he=s.RG8I),W===s.SHORT&&(he=s.RG16I),W===s.INT&&(he=s.RG32I)),E===s.RGB_INTEGER&&(W===s.UNSIGNED_BYTE&&(he=s.RGB8UI),W===s.UNSIGNED_SHORT&&(he=s.RGB16UI),W===s.UNSIGNED_INT&&(he=s.RGB32UI),W===s.BYTE&&(he=s.RGB8I),W===s.SHORT&&(he=s.RGB16I),W===s.INT&&(he=s.RGB32I)),E===s.RGBA_INTEGER&&(W===s.UNSIGNED_BYTE&&(he=s.RGBA8UI),W===s.UNSIGNED_SHORT&&(he=s.RGBA16UI),W===s.UNSIGNED_INT&&(he=s.RGBA32UI),W===s.BYTE&&(he=s.RGBA8I),W===s.SHORT&&(he=s.RGBA16I),W===s.INT&&(he=s.RGBA32I)),E===s.RGB&&(W===s.UNSIGNED_INT_5_9_9_9_REV&&(he=s.RGB9_E5),W===s.UNSIGNED_INT_10F_11F_11F_REV&&(he=s.R11F_G11F_B10F)),E===s.RGBA){const ke=ye?jc:Ct.getTransfer(pe);W===s.FLOAT&&(he=s.RGBA32F),W===s.HALF_FLOAT&&(he=s.RGBA16F),W===s.UNSIGNED_BYTE&&(he=ke===Gt?s.SRGB8_ALPHA8:s.RGBA8),W===s.UNSIGNED_SHORT_4_4_4_4&&(he=s.RGBA4),W===s.UNSIGNED_SHORT_5_5_5_1&&(he=s.RGB5_A1)}return(he===s.R16F||he===s.R32F||he===s.RG16F||he===s.RG32F||he===s.RGBA16F||he===s.RGBA32F)&&t.get("EXT_color_buffer_float"),he}function N(P,E){let W;return P?E===null||E===ki||E===el?W=s.DEPTH24_STENCIL8:E===Bi?W=s.DEPTH32F_STENCIL8:E===$o&&(W=s.DEPTH24_STENCIL8,dt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===ki||E===el?W=s.DEPTH_COMPONENT24:E===Bi?W=s.DEPTH_COMPONENT32F:E===$o&&(W=s.DEPTH_COMPONENT16),W}function D(P,E){return M(P)===!0||P.isFramebufferTexture&&P.minFilter!==Dn&&P.minFilter!==dn?Math.log2(Math.max(E.width,E.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?E.mipmaps.length:1}function O(P){const E=P.target;E.removeEventListener("dispose",O),z(E),E.isVideoTexture&&_.delete(E)}function L(P){const E=P.target;E.removeEventListener("dispose",L),C(E)}function z(P){const E=r.get(P);if(E.__webglInit===void 0)return;const W=P.source,pe=v.get(W);if(pe){const ye=pe[E.__cacheKey];ye.usedTimes--,ye.usedTimes===0&&A(P),Object.keys(pe).length===0&&v.delete(W)}r.remove(P)}function A(P){const E=r.get(P);s.deleteTexture(E.__webglTexture);const W=P.source,pe=v.get(W);delete pe[E.__cacheKey],d.memory.textures--}function C(P){const E=r.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),r.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let pe=0;pe<6;pe++){if(Array.isArray(E.__webglFramebuffer[pe]))for(let ye=0;ye<E.__webglFramebuffer[pe].length;ye++)s.deleteFramebuffer(E.__webglFramebuffer[pe][ye]);else s.deleteFramebuffer(E.__webglFramebuffer[pe]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[pe])}else{if(Array.isArray(E.__webglFramebuffer))for(let pe=0;pe<E.__webglFramebuffer.length;pe++)s.deleteFramebuffer(E.__webglFramebuffer[pe]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let pe=0;pe<E.__webglColorRenderbuffer.length;pe++)E.__webglColorRenderbuffer[pe]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[pe]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=P.textures;for(let pe=0,ye=W.length;pe<ye;pe++){const he=r.get(W[pe]);he.__webglTexture&&(s.deleteTexture(he.__webglTexture),d.memory.textures--),r.remove(W[pe])}r.remove(P)}let H=0;function J(){H=0}function q(){const P=H;return P>=l.maxTextures&&dt("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l.maxTextures),H+=1,P}function ne(P){const E=[];return E.push(P.wrapS),E.push(P.wrapT),E.push(P.wrapR||0),E.push(P.magFilter),E.push(P.minFilter),E.push(P.anisotropy),E.push(P.internalFormat),E.push(P.format),E.push(P.type),E.push(P.generateMipmaps),E.push(P.premultiplyAlpha),E.push(P.flipY),E.push(P.unpackAlignment),E.push(P.colorSpace),E.join()}function $(P,E){const W=r.get(P);if(P.isVideoTexture&&Qe(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&W.__version!==P.version){const pe=P.image;if(pe===null)dt("WebGLRenderer: Texture marked for update but no image data found.");else if(pe.complete===!1)dt("WebGLRenderer: Texture marked for update but image is incomplete");else{Q(W,P,E);return}}else P.isExternalTexture&&(W.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(s.TEXTURE_2D,W.__webglTexture,s.TEXTURE0+E)}function B(P,E){const W=r.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&W.__version!==P.version){Q(W,P,E);return}else P.isExternalTexture&&(W.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(s.TEXTURE_2D_ARRAY,W.__webglTexture,s.TEXTURE0+E)}function G(P,E){const W=r.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&W.__version!==P.version){Q(W,P,E);return}i.bindTexture(s.TEXTURE_3D,W.__webglTexture,s.TEXTURE0+E)}function te(P,E){const W=r.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&W.__version!==P.version){ae(W,P,E);return}i.bindTexture(s.TEXTURE_CUBE_MAP,W.__webglTexture,s.TEXTURE0+E)}const ve={[ah]:s.REPEAT,[ti]:s.CLAMP_TO_EDGE,[rh]:s.MIRRORED_REPEAT},ge={[Dn]:s.NEAREST,[wy]:s.NEAREST_MIPMAP_NEAREST,[yc]:s.NEAREST_MIPMAP_LINEAR,[dn]:s.LINEAR,[fd]:s.LINEAR_MIPMAP_NEAREST,[Nr]:s.LINEAR_MIPMAP_LINEAR},F={[Ly]:s.NEVER,[By]:s.ALWAYS,[Oy]:s.LESS,[Kh]:s.LEQUAL,[Py]:s.EQUAL,[Qh]:s.GEQUAL,[Fy]:s.GREATER,[Iy]:s.NOTEQUAL};function ie(P,E){if(E.type===Bi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===dn||E.magFilter===fd||E.magFilter===yc||E.magFilter===Nr||E.minFilter===dn||E.minFilter===fd||E.minFilter===yc||E.minFilter===Nr)&&dt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(P,s.TEXTURE_WRAP_S,ve[E.wrapS]),s.texParameteri(P,s.TEXTURE_WRAP_T,ve[E.wrapT]),(P===s.TEXTURE_3D||P===s.TEXTURE_2D_ARRAY)&&s.texParameteri(P,s.TEXTURE_WRAP_R,ve[E.wrapR]),s.texParameteri(P,s.TEXTURE_MAG_FILTER,ge[E.magFilter]),s.texParameteri(P,s.TEXTURE_MIN_FILTER,ge[E.minFilter]),E.compareFunction&&(s.texParameteri(P,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(P,s.TEXTURE_COMPARE_FUNC,F[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Dn||E.minFilter!==yc&&E.minFilter!==Nr||E.type===Bi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");s.texParameterf(P,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function _e(P,E){let W=!1;P.__webglInit===void 0&&(P.__webglInit=!0,E.addEventListener("dispose",O));const pe=E.source;let ye=v.get(pe);ye===void 0&&(ye={},v.set(pe,ye));const he=ne(E);if(he!==P.__cacheKey){ye[he]===void 0&&(ye[he]={texture:s.createTexture(),usedTimes:0},d.memory.textures++,W=!0),ye[he].usedTimes++;const ke=ye[P.__cacheKey];ke!==void 0&&(ye[P.__cacheKey].usedTimes--,ke.usedTimes===0&&A(E)),P.__cacheKey=he,P.__webglTexture=ye[he].texture}return W}function de(P,E,W){return Math.floor(Math.floor(P/W)/E)}function be(P,E,W,pe){const he=P.updateRanges;if(he.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,W,pe,E.data);else{he.sort((Ee,Ce)=>Ee.start-Ce.start);let ke=0;for(let Ee=1;Ee<he.length;Ee++){const Ce=he[ke],Ie=he[Ee],Pe=Ce.start+Ce.count,we=de(Ie.start,E.width,4),gt=de(Ce.start,E.width,4);Ie.start<=Pe+1&&we===gt&&de(Ie.start+Ie.count-1,E.width,4)===we?Ce.count=Math.max(Ce.count,Ie.start+Ie.count-Ce.start):(++ke,he[ke]=Ie)}he.length=ke+1;const Re=s.getParameter(s.UNPACK_ROW_LENGTH),We=s.getParameter(s.UNPACK_SKIP_PIXELS),nt=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let Ee=0,Ce=he.length;Ee<Ce;Ee++){const Ie=he[Ee],Pe=Math.floor(Ie.start/4),we=Math.ceil(Ie.count/4),gt=Pe%E.width,Y=Math.floor(Pe/E.width),Le=we,De=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,gt),s.pixelStorei(s.UNPACK_SKIP_ROWS,Y),i.texSubImage2D(s.TEXTURE_2D,0,gt,Y,Le,De,W,pe,E.data)}P.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Re),s.pixelStorei(s.UNPACK_SKIP_PIXELS,We),s.pixelStorei(s.UNPACK_SKIP_ROWS,nt)}}function Q(P,E,W){let pe=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(pe=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(pe=s.TEXTURE_3D);const ye=_e(P,E),he=E.source;i.bindTexture(pe,P.__webglTexture,s.TEXTURE0+W);const ke=r.get(he);if(he.version!==ke.__version||ye===!0){i.activeTexture(s.TEXTURE0+W);const Re=Ct.getPrimaries(Ct.workingColorSpace),We=E.colorSpace===nr?null:Ct.getPrimaries(E.colorSpace),nt=E.colorSpace===nr||Re===We?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);let Ee=T(E.image,!1,l.maxTextureSize);Ee=ut(E,Ee);const Ce=c.convert(E.format,E.colorSpace),Ie=c.convert(E.type);let Pe=U(E.internalFormat,Ce,Ie,E.colorSpace,E.isVideoTexture);ie(pe,E);let we;const gt=E.mipmaps,Y=E.isVideoTexture!==!0,Le=ke.__version===void 0||ye===!0,De=he.dataReady,ze=D(E,Ee);if(E.isDepthTexture)Pe=N(E.format===Lr,E.type),Le&&(Y?i.texStorage2D(s.TEXTURE_2D,1,Pe,Ee.width,Ee.height):i.texImage2D(s.TEXTURE_2D,0,Pe,Ee.width,Ee.height,0,Ce,Ie,null));else if(E.isDataTexture)if(gt.length>0){Y&&Le&&i.texStorage2D(s.TEXTURE_2D,ze,Pe,gt[0].width,gt[0].height);for(let Te=0,Me=gt.length;Te<Me;Te++)we=gt[Te],Y?De&&i.texSubImage2D(s.TEXTURE_2D,Te,0,0,we.width,we.height,Ce,Ie,we.data):i.texImage2D(s.TEXTURE_2D,Te,Pe,we.width,we.height,0,Ce,Ie,we.data);E.generateMipmaps=!1}else Y?(Le&&i.texStorage2D(s.TEXTURE_2D,ze,Pe,Ee.width,Ee.height),De&&be(E,Ee,Ce,Ie)):i.texImage2D(s.TEXTURE_2D,0,Pe,Ee.width,Ee.height,0,Ce,Ie,Ee.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){Y&&Le&&i.texStorage3D(s.TEXTURE_2D_ARRAY,ze,Pe,gt[0].width,gt[0].height,Ee.depth);for(let Te=0,Me=gt.length;Te<Me;Te++)if(we=gt[Te],E.format!==Ci)if(Ce!==null)if(Y){if(De)if(E.layerUpdates.size>0){const Ue=g_(we.width,we.height,E.format,E.type);for(const ot of E.layerUpdates){const It=we.data.subarray(ot*Ue/we.data.BYTES_PER_ELEMENT,(ot+1)*Ue/we.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Te,0,0,ot,we.width,we.height,1,Ce,It)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Te,0,0,0,we.width,we.height,Ee.depth,Ce,we.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Te,Pe,we.width,we.height,Ee.depth,0,we.data,0,0);else dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Y?De&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,Te,0,0,0,we.width,we.height,Ee.depth,Ce,Ie,we.data):i.texImage3D(s.TEXTURE_2D_ARRAY,Te,Pe,we.width,we.height,Ee.depth,0,Ce,Ie,we.data)}else{Y&&Le&&i.texStorage2D(s.TEXTURE_2D,ze,Pe,gt[0].width,gt[0].height);for(let Te=0,Me=gt.length;Te<Me;Te++)we=gt[Te],E.format!==Ci?Ce!==null?Y?De&&i.compressedTexSubImage2D(s.TEXTURE_2D,Te,0,0,we.width,we.height,Ce,we.data):i.compressedTexImage2D(s.TEXTURE_2D,Te,Pe,we.width,we.height,0,we.data):dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Y?De&&i.texSubImage2D(s.TEXTURE_2D,Te,0,0,we.width,we.height,Ce,Ie,we.data):i.texImage2D(s.TEXTURE_2D,Te,Pe,we.width,we.height,0,Ce,Ie,we.data)}else if(E.isDataArrayTexture)if(Y){if(Le&&i.texStorage3D(s.TEXTURE_2D_ARRAY,ze,Pe,Ee.width,Ee.height,Ee.depth),De)if(E.layerUpdates.size>0){const Te=g_(Ee.width,Ee.height,E.format,E.type);for(const Me of E.layerUpdates){const Ue=Ee.data.subarray(Me*Te/Ee.data.BYTES_PER_ELEMENT,(Me+1)*Te/Ee.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Me,Ee.width,Ee.height,1,Ce,Ie,Ue)}E.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Ee.width,Ee.height,Ee.depth,Ce,Ie,Ee.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Pe,Ee.width,Ee.height,Ee.depth,0,Ce,Ie,Ee.data);else if(E.isData3DTexture)Y?(Le&&i.texStorage3D(s.TEXTURE_3D,ze,Pe,Ee.width,Ee.height,Ee.depth),De&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Ee.width,Ee.height,Ee.depth,Ce,Ie,Ee.data)):i.texImage3D(s.TEXTURE_3D,0,Pe,Ee.width,Ee.height,Ee.depth,0,Ce,Ie,Ee.data);else if(E.isFramebufferTexture){if(Le)if(Y)i.texStorage2D(s.TEXTURE_2D,ze,Pe,Ee.width,Ee.height);else{let Te=Ee.width,Me=Ee.height;for(let Ue=0;Ue<ze;Ue++)i.texImage2D(s.TEXTURE_2D,Ue,Pe,Te,Me,0,Ce,Ie,null),Te>>=1,Me>>=1}}else if(gt.length>0){if(Y&&Le){const Te=Ve(gt[0]);i.texStorage2D(s.TEXTURE_2D,ze,Pe,Te.width,Te.height)}for(let Te=0,Me=gt.length;Te<Me;Te++)we=gt[Te],Y?De&&i.texSubImage2D(s.TEXTURE_2D,Te,0,0,Ce,Ie,we):i.texImage2D(s.TEXTURE_2D,Te,Pe,Ce,Ie,we);E.generateMipmaps=!1}else if(Y){if(Le){const Te=Ve(Ee);i.texStorage2D(s.TEXTURE_2D,ze,Pe,Te.width,Te.height)}De&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Ce,Ie,Ee)}else i.texImage2D(s.TEXTURE_2D,0,Pe,Ce,Ie,Ee);M(E)&&x(pe),ke.__version=he.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function ae(P,E,W){if(E.image.length!==6)return;const pe=_e(P,E),ye=E.source;i.bindTexture(s.TEXTURE_CUBE_MAP,P.__webglTexture,s.TEXTURE0+W);const he=r.get(ye);if(ye.version!==he.__version||pe===!0){i.activeTexture(s.TEXTURE0+W);const ke=Ct.getPrimaries(Ct.workingColorSpace),Re=E.colorSpace===nr?null:Ct.getPrimaries(E.colorSpace),We=E.colorSpace===nr||ke===Re?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,We);const nt=E.isCompressedTexture||E.image[0].isCompressedTexture,Ee=E.image[0]&&E.image[0].isDataTexture,Ce=[];for(let Me=0;Me<6;Me++)!nt&&!Ee?Ce[Me]=T(E.image[Me],!0,l.maxCubemapSize):Ce[Me]=Ee?E.image[Me].image:E.image[Me],Ce[Me]=ut(E,Ce[Me]);const Ie=Ce[0],Pe=c.convert(E.format,E.colorSpace),we=c.convert(E.type),gt=U(E.internalFormat,Pe,we,E.colorSpace),Y=E.isVideoTexture!==!0,Le=he.__version===void 0||pe===!0,De=ye.dataReady;let ze=D(E,Ie);ie(s.TEXTURE_CUBE_MAP,E);let Te;if(nt){Y&&Le&&i.texStorage2D(s.TEXTURE_CUBE_MAP,ze,gt,Ie.width,Ie.height);for(let Me=0;Me<6;Me++){Te=Ce[Me].mipmaps;for(let Ue=0;Ue<Te.length;Ue++){const ot=Te[Ue];E.format!==Ci?Pe!==null?Y?De&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue,0,0,ot.width,ot.height,Pe,ot.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue,gt,ot.width,ot.height,0,ot.data):dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Y?De&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue,0,0,ot.width,ot.height,Pe,we,ot.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue,gt,ot.width,ot.height,0,Pe,we,ot.data)}}}else{if(Te=E.mipmaps,Y&&Le){Te.length>0&&ze++;const Me=Ve(Ce[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,ze,gt,Me.width,Me.height)}for(let Me=0;Me<6;Me++)if(Ee){Y?De&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,Ce[Me].width,Ce[Me].height,Pe,we,Ce[Me].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,gt,Ce[Me].width,Ce[Me].height,0,Pe,we,Ce[Me].data);for(let Ue=0;Ue<Te.length;Ue++){const It=Te[Ue].image[Me].image;Y?De&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue+1,0,0,It.width,It.height,Pe,we,It.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue+1,gt,It.width,It.height,0,Pe,we,It.data)}}else{Y?De&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,Pe,we,Ce[Me]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,gt,Pe,we,Ce[Me]);for(let Ue=0;Ue<Te.length;Ue++){const ot=Te[Ue];Y?De&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue+1,0,0,Pe,we,ot.image[Me]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Me,Ue+1,gt,Pe,we,ot.image[Me])}}}M(E)&&x(s.TEXTURE_CUBE_MAP),he.__version=ye.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function Ae(P,E,W,pe,ye,he){const ke=c.convert(W.format,W.colorSpace),Re=c.convert(W.type),We=U(W.internalFormat,ke,Re,W.colorSpace),nt=r.get(E),Ee=r.get(W);if(Ee.__renderTarget=E,!nt.__hasExternalTextures){const Ce=Math.max(1,E.width>>he),Ie=Math.max(1,E.height>>he);ye===s.TEXTURE_3D||ye===s.TEXTURE_2D_ARRAY?i.texImage3D(ye,he,We,Ce,Ie,E.depth,0,ke,Re,null):i.texImage2D(ye,he,We,Ce,Ie,0,ke,Re,null)}i.bindFramebuffer(s.FRAMEBUFFER,P),St(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,pe,ye,Ee.__webglTexture,0,k(E)):(ye===s.TEXTURE_2D||ye>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ye<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,pe,ye,Ee.__webglTexture,he),i.bindFramebuffer(s.FRAMEBUFFER,null)}function He(P,E,W){if(s.bindRenderbuffer(s.RENDERBUFFER,P),E.depthBuffer){const pe=E.depthTexture,ye=pe&&pe.isDepthTexture?pe.type:null,he=N(E.stencilBuffer,ye),ke=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;St(E)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,k(E),he,E.width,E.height):W?s.renderbufferStorageMultisample(s.RENDERBUFFER,k(E),he,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,he,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,ke,s.RENDERBUFFER,P)}else{const pe=E.textures;for(let ye=0;ye<pe.length;ye++){const he=pe[ye],ke=c.convert(he.format,he.colorSpace),Re=c.convert(he.type),We=U(he.internalFormat,ke,Re,he.colorSpace);St(E)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,k(E),We,E.width,E.height):W?s.renderbufferStorageMultisample(s.RENDERBUFFER,k(E),We,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,We,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ge(P,E,W){const pe=E.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(s.FRAMEBUFFER,P),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ye=r.get(E.depthTexture);if(ye.__renderTarget=E,(!ye.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),pe){if(ye.__webglInit===void 0&&(ye.__webglInit=!0,E.depthTexture.addEventListener("dispose",O)),ye.__webglTexture===void 0){ye.__webglTexture=s.createTexture(),i.bindTexture(s.TEXTURE_CUBE_MAP,ye.__webglTexture),ie(s.TEXTURE_CUBE_MAP,E.depthTexture);const nt=c.convert(E.depthTexture.format),Ee=c.convert(E.depthTexture.type);let Ce;E.depthTexture.format===Sa?Ce=s.DEPTH_COMPONENT24:E.depthTexture.format===Lr&&(Ce=s.DEPTH24_STENCIL8);for(let Ie=0;Ie<6;Ie++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ie,0,Ce,E.width,E.height,0,nt,Ee,null)}}else $(E.depthTexture,0);const he=ye.__webglTexture,ke=k(E),Re=pe?s.TEXTURE_CUBE_MAP_POSITIVE_X+W:s.TEXTURE_2D,We=E.depthTexture.format===Lr?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(E.depthTexture.format===Sa)St(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,We,Re,he,0,ke):s.framebufferTexture2D(s.FRAMEBUFFER,We,Re,he,0);else if(E.depthTexture.format===Lr)St(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,We,Re,he,0,ke):s.framebufferTexture2D(s.FRAMEBUFFER,We,Re,he,0);else throw new Error("Unknown depthTexture format")}function ct(P){const E=r.get(P),W=P.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==P.depthTexture){const pe=P.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),pe){const ye=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,pe.removeEventListener("dispose",ye)};pe.addEventListener("dispose",ye),E.__depthDisposeCallback=ye}E.__boundDepthTexture=pe}if(P.depthTexture&&!E.__autoAllocateDepthBuffer)if(W)for(let pe=0;pe<6;pe++)Ge(E.__webglFramebuffer[pe],P,pe);else{const pe=P.texture.mipmaps;pe&&pe.length>0?Ge(E.__webglFramebuffer[0],P,0):Ge(E.__webglFramebuffer,P,0)}else if(W){E.__webglDepthbuffer=[];for(let pe=0;pe<6;pe++)if(i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[pe]),E.__webglDepthbuffer[pe]===void 0)E.__webglDepthbuffer[pe]=s.createRenderbuffer(),He(E.__webglDepthbuffer[pe],P,!1);else{const ye=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,he=E.__webglDepthbuffer[pe];s.bindRenderbuffer(s.RENDERBUFFER,he),s.framebufferRenderbuffer(s.FRAMEBUFFER,ye,s.RENDERBUFFER,he)}}else{const pe=P.texture.mipmaps;if(pe&&pe.length>0?i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),He(E.__webglDepthbuffer,P,!1);else{const ye=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,he=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,he),s.framebufferRenderbuffer(s.FRAMEBUFFER,ye,s.RENDERBUFFER,he)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function Yt(P,E,W){const pe=r.get(P);E!==void 0&&Ae(pe.__webglFramebuffer,P,P.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),W!==void 0&&ct(P)}function pt(P){const E=P.texture,W=r.get(P),pe=r.get(E);P.addEventListener("dispose",L);const ye=P.textures,he=P.isWebGLCubeRenderTarget===!0,ke=ye.length>1;if(ke||(pe.__webglTexture===void 0&&(pe.__webglTexture=s.createTexture()),pe.__version=E.version,d.memory.textures++),he){W.__webglFramebuffer=[];for(let Re=0;Re<6;Re++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[Re]=[];for(let We=0;We<E.mipmaps.length;We++)W.__webglFramebuffer[Re][We]=s.createFramebuffer()}else W.__webglFramebuffer[Re]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let Re=0;Re<E.mipmaps.length;Re++)W.__webglFramebuffer[Re]=s.createFramebuffer()}else W.__webglFramebuffer=s.createFramebuffer();if(ke)for(let Re=0,We=ye.length;Re<We;Re++){const nt=r.get(ye[Re]);nt.__webglTexture===void 0&&(nt.__webglTexture=s.createTexture(),d.memory.textures++)}if(P.samples>0&&St(P)===!1){W.__webglMultisampledFramebuffer=s.createFramebuffer(),W.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let Re=0;Re<ye.length;Re++){const We=ye[Re];W.__webglColorRenderbuffer[Re]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,W.__webglColorRenderbuffer[Re]);const nt=c.convert(We.format,We.colorSpace),Ee=c.convert(We.type),Ce=U(We.internalFormat,nt,Ee,We.colorSpace,P.isXRRenderTarget===!0),Ie=k(P);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ie,Ce,P.width,P.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Re,s.RENDERBUFFER,W.__webglColorRenderbuffer[Re])}s.bindRenderbuffer(s.RENDERBUFFER,null),P.depthBuffer&&(W.__webglDepthRenderbuffer=s.createRenderbuffer(),He(W.__webglDepthRenderbuffer,P,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(he){i.bindTexture(s.TEXTURE_CUBE_MAP,pe.__webglTexture),ie(s.TEXTURE_CUBE_MAP,E);for(let Re=0;Re<6;Re++)if(E.mipmaps&&E.mipmaps.length>0)for(let We=0;We<E.mipmaps.length;We++)Ae(W.__webglFramebuffer[Re][We],P,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Re,We);else Ae(W.__webglFramebuffer[Re],P,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Re,0);M(E)&&x(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(ke){for(let Re=0,We=ye.length;Re<We;Re++){const nt=ye[Re],Ee=r.get(nt);let Ce=s.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Ce=P.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Ce,Ee.__webglTexture),ie(Ce,nt),Ae(W.__webglFramebuffer,P,nt,s.COLOR_ATTACHMENT0+Re,Ce,0),M(nt)&&x(Ce)}i.unbindTexture()}else{let Re=s.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Re=P.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Re,pe.__webglTexture),ie(Re,E),E.mipmaps&&E.mipmaps.length>0)for(let We=0;We<E.mipmaps.length;We++)Ae(W.__webglFramebuffer[We],P,E,s.COLOR_ATTACHMENT0,Re,We);else Ae(W.__webglFramebuffer,P,E,s.COLOR_ATTACHMENT0,Re,0);M(E)&&x(Re),i.unbindTexture()}P.depthBuffer&&ct(P)}function mt(P){const E=P.textures;for(let W=0,pe=E.length;W<pe;W++){const ye=E[W];if(M(ye)){const he=I(P),ke=r.get(ye).__webglTexture;i.bindTexture(he,ke),x(he),i.unbindTexture()}}}const st=[],Ke=[];function et(P){if(P.samples>0){if(St(P)===!1){const E=P.textures,W=P.width,pe=P.height;let ye=s.COLOR_BUFFER_BIT;const he=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ke=r.get(P),Re=E.length>1;if(Re)for(let nt=0;nt<E.length;nt++)i.bindFramebuffer(s.FRAMEBUFFER,ke.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,ke.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,ke.__webglMultisampledFramebuffer);const We=P.texture.mipmaps;We&&We.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,ke.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,ke.__webglFramebuffer);for(let nt=0;nt<E.length;nt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(ye|=s.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(ye|=s.STENCIL_BUFFER_BIT)),Re){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ke.__webglColorRenderbuffer[nt]);const Ee=r.get(E[nt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Ee,0)}s.blitFramebuffer(0,0,W,pe,0,0,W,pe,ye,s.NEAREST),m===!0&&(st.length=0,Ke.length=0,st.push(s.COLOR_ATTACHMENT0+nt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(st.push(he),Ke.push(he),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ke)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,st))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Re)for(let nt=0;nt<E.length;nt++){i.bindFramebuffer(s.FRAMEBUFFER,ke.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,ke.__webglColorRenderbuffer[nt]);const Ee=r.get(E[nt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,ke.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,Ee,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,ke.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&m){const E=P.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function k(P){return Math.min(l.maxSamples,P.samples)}function St(P){const E=r.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Qe(P){const E=d.render.frame;_.get(P)!==E&&(_.set(P,E),P.update())}function ut(P,E){const W=P.colorSpace,pe=P.format,ye=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||W!==Bs&&W!==nr&&(Ct.getTransfer(W)===Gt?(pe!==Ci||ye!==mi)&&dt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ut("WebGLTextures: Unsupported texture color space:",W)),E}function Ve(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(p.width=P.naturalWidth||P.width,p.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(p.width=P.displayWidth,p.height=P.displayHeight):(p.width=P.width,p.height=P.height),p}this.allocateTextureUnit=q,this.resetTextureUnits=J,this.setTexture2D=$,this.setTexture2DArray=B,this.setTexture3D=G,this.setTextureCube=te,this.rebindTextures=Yt,this.setupRenderTarget=pt,this.updateRenderTargetMipmap=mt,this.updateMultisampleRenderTarget=et,this.setupDepthRenderbuffer=ct,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=St,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function fA(s,t){function i(r,l=nr){let c;const d=Ct.getTransfer(l);if(r===mi)return s.UNSIGNED_BYTE;if(r===Wh)return s.UNSIGNED_SHORT_4_4_4_4;if(r===qh)return s.UNSIGNED_SHORT_5_5_5_1;if(r===pv)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===mv)return s.UNSIGNED_INT_10F_11F_11F_REV;if(r===dv)return s.BYTE;if(r===hv)return s.SHORT;if(r===$o)return s.UNSIGNED_SHORT;if(r===Xh)return s.INT;if(r===ki)return s.UNSIGNED_INT;if(r===Bi)return s.FLOAT;if(r===xa)return s.HALF_FLOAT;if(r===gv)return s.ALPHA;if(r===_v)return s.RGB;if(r===Ci)return s.RGBA;if(r===Sa)return s.DEPTH_COMPONENT;if(r===Lr)return s.DEPTH_STENCIL;if(r===vv)return s.RED;if(r===Yh)return s.RED_INTEGER;if(r===Is)return s.RG;if(r===jh)return s.RG_INTEGER;if(r===Zh)return s.RGBA_INTEGER;if(r===kc||r===Xc||r===Wc||r===qc)if(d===Gt)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(r===kc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Xc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Wc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===qc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(r===kc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Xc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Wc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===qc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===sh||r===oh||r===lh||r===ch)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(r===sh)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===oh)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===lh)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===ch)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===uh||r===fh||r===dh||r===hh||r===ph||r===mh||r===gh)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(r===uh||r===fh)return d===Gt?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(r===dh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(r===hh)return c.COMPRESSED_R11_EAC;if(r===ph)return c.COMPRESSED_SIGNED_R11_EAC;if(r===mh)return c.COMPRESSED_RG11_EAC;if(r===gh)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(r===_h||r===vh||r===xh||r===Sh||r===yh||r===Mh||r===Eh||r===bh||r===Th||r===Ah||r===Rh||r===Ch||r===wh||r===Dh)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(r===_h)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===vh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===xh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Sh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===yh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===Mh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Eh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===bh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Th)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Ah)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Rh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Ch)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===wh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Dh)return d===Gt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Uh||r===Nh||r===Lh)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(r===Uh)return d===Gt?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===Nh)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Lh)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Oh||r===Ph||r===Fh||r===Ih)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(r===Oh)return c.COMPRESSED_RED_RGTC1_EXT;if(r===Ph)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Fh)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Ih)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===el?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const dA=`
void main() {
...
void main() {
...
}`;class pA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const r=new Nv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,r=new gi({vertexShader:dA,fragmentShader:hA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new wi(new Gs(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class mA extends Hs{constructor(t,i){super();const r=this;let l=null,c=1,d=null,h="local-floor",m=1,p=null,_=null,g=null,v=null,y=null,b=null;const T=typeof XRWebGLBinding<"u",M=new pA,x={},I=i.getContextAttributes();let U=null,N=null;const D=[],O=[],L=new Nt;let z=null;const A=new Ai;A.viewport=new rn;const C=new Ai;C.viewport=new rn;const H=[A,C],J=new bM;let q=null,ne=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ae=D[Q];return ae===void 0&&(ae=new Od,D[Q]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function(Q){let ae=D[Q];return ae===void 0&&(ae=new Od,D[Q]=ae),ae.getGripSpace()},this.getHand=function(Q){let ae=D[Q];return ae===void 0&&(ae=new Od,D[Q]=ae),ae.getHandSpace()};function $(Q){const ae=O.indexOf(Q.inputSource);if(ae===-1)return;const Ae=D[ae];Ae!==void 0&&(Ae.update(Q.inputSource,Q.frame,p||d),Ae.dispatchEvent({type:Q.type,data:Q.inputSource}))}function B(){l.removeEventListener("select",$),l.removeEventListener("selectstart",$),l.removeEventListener("selectend",$),l.removeEventListener("squeeze",$),l.removeEventListener("squeezestart",$),l.removeEventListener("squeezeend",$),l.removeEventListener("end",B),l.removeEventListener("inputsourceschange",G);for(let Q=0;Q<D.length;Q++){const ae=O[Q];ae!==null&&(O[Q]=null,D[Q].disconnect(ae))}q=null,ne=null,M.reset();for(const Q in x)delete x[Q];t.setRenderTarget(U),y=null,v=null,g=null,l=null,N=null,be.stop(),r.isPresenting=!1,t.setPixelRatio(z),t.setSize(L.width,L.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){c=Q,r.isPresenting===!0&&dt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){h=Q,r.isPresenting===!0&&dt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return v!==null?v:y},this.getBinding=function(){return g===null&&T&&(g=new XRWebGLBinding(l,i)),g},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(Q){if(l=Q,l!==null){if(U=t.getRenderTarget(),l.addEventListener("select",$),l.addEventListener("selectstart",$),l.addEventListener("selectend",$),l.addEventListener("squeeze",$),l.addEventListener("squeezestart",$),l.addEventListener("squeezeend",$),l.addEventListener("end",B),l.addEventListener("inputsourceschange",G),I.xrCompatible!==!0&&await i.makeXRCompatible(),z=t.getPixelRatio(),t.getSize(L),T&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ae=null,He=null,Ge=null;I.depth&&(Ge=I.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ae=I.stencil?Lr:Sa,He=I.stencil?el:ki);const ct={colorFormat:i.RGBA8,depthFormat:Ge,scaleFactor:c};g=this.getBinding(),v=g.createProjectionLayer(ct),l.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),N=new Gi(v.textureWidth,v.textureHeight,{format:Ci,type:mi,depthTexture:new il(v.textureWidth,v.textureHeight,He,void 0,void 0,void 0,void 0,void 0,void 0,Ae),stencilBuffer:I.stencil,colorSpace:t.outputColorSpace,samples:I.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const Ae={antialias:I.antialias,alpha:!0,depth:I.depth,stencil:I.stencil,framebufferScaleFactor:c};y=new XRWebGLLayer(l,i,Ae),l.updateRenderState({baseLayer:y}),t.setPixelRatio(1),t.setSize(y.framebufferWidth,y.framebufferHeight,!1),N=new Gi(y.framebufferWidth,y.framebufferHeight,{format:Ci,type:mi,colorSpace:t.outputColorSpace,stencilBuffer:I.stencil,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}N.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),be.setContext(l),be.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function G(Q){for(let ae=0;ae<Q.removed.length;ae++){const Ae=Q.removed[ae],He=O.indexOf(Ae);He>=0&&(O[He]=null,D[He].disconnect(Ae))}for(let ae=0;ae<Q.added.length;ae++){const Ae=Q.added[ae];let He=O.indexOf(Ae);if(He===-1){for(let ct=0;ct<D.length;ct++)if(ct>=O.length){O.push(Ae),He=ct;break}else if(O[ct]===null){O[ct]=Ae,He=ct;break}if(He===-1)break}const Ge=D[He];Ge&&Ge.connect(Ae)}}const te=new ce,ve=new ce;function ge(Q,ae,Ae){te.setFromMatrixPosition(ae.matrixWorld),ve.setFromMatrixPosition(Ae.matrixWorld);const He=te.distanceTo(ve),Ge=ae.projectionMatrix.elements,ct=Ae.projectionMatrix.elements,Yt=Ge[14]/(Ge[10]-1),pt=Ge[14]/(Ge[10]+1),mt=(Ge[9]+1)/Ge[5],st=(Ge[9]-1)/Ge[5],Ke=(Ge[8]-1)/Ge[0],et=(ct[8]+1)/ct[0],k=Yt*Ke,St=Yt*et,Qe=He/(-Ke+et),ut=Qe*-Ke;if(ae.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ut),Q.translateZ(Qe),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),Ge[10]===-1)Q.projectionMatrix.copy(ae.projectionMatrix),Q.projectionMatrixInverse.copy(ae.projectionMatrixInverse);else{const Ve=Yt+Qe,P=pt+Qe,E=k-ut,W=St+(He-ut),pe=mt*pt/P*Ve,ye=st*pt/P*Ve;Q.projectionMatrix.makePerspective(E,W,pe,ye,Ve,P),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function F(Q,ae){ae===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ae.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(l===null)return;let ae=Q.near,Ae=Q.far;M.texture!==null&&(M.depthNear>0&&(ae=M.depthNear),M.depthFar>0&&(Ae=M.depthFar)),J.near=C.near=A.near=ae,J.far=C.far=A.far=Ae,(q!==J.near||ne!==J.far)&&(l.updateRenderState({depthNear:J.near,depthFar:J.far}),q=J.near,ne=J.far),J.layers.mask=Q.layers.mask|6,A.layers.mask=J.layers.mask&3,C.layers.mask=J.layers.mask&5;const He=Q.parent,Ge=J.cameras;F(J,He);for(let ct=0;ct<Ge.length;ct++)F(Ge[ct],He);Ge.length===2?ge(J,A,C):J.projectionMatrix.copy(A.projectionMatrix),ie(Q,J,He)};function ie(Q,ae,Ae){Ae===null?Q.matrix.copy(ae.matrixWorld):(Q.matrix.copy(Ae.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ae.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ae.projectionMatrix),Q.projectionMatrixInverse.copy(ae.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=Bh*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return J},this.getFoveation=function(){if(!(v===null&&y===null))return m},this.setFoveation=function(Q){m=Q,v!==null&&(v.fixedFoveation=Q),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=Q)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(J)},this.getCameraTexture=function(Q){return x[Q]};let _e=null;function de(Q,ae){if(_=ae.getViewerPose(p||d),b=ae,_!==null){const Ae=_.views;y!==null&&(t.setRenderTargetFramebuffer(N,y.framebuffer),t.setRenderTarget(N));let He=!1;Ae.length!==J.cameras.length&&(J.cameras.length=0,He=!0);for(let pt=0;pt<Ae.length;pt++){const mt=Ae[pt];let st=null;if(y!==null)st=y.getViewport(mt);else{const et=g.getViewSubImage(v,mt);st=et.viewport,pt===0&&(t.setRenderTargetTextures(N,et.colorTexture,et.depthStencilTexture),t.setRenderTarget(N))}let Ke=H[pt];Ke===void 0&&(Ke=new Ai,Ke.layers.enable(pt),Ke.viewport=new rn,H[pt]=Ke),Ke.matrix.fromArray(mt.transform.matrix),Ke.matrix.decompose(Ke.position,Ke.quaternion,Ke.scale),Ke.projectionMatrix.fromArray(mt.projectionMatrix),Ke.projectionMatrixInverse.copy(Ke.projectionMatrix).invert(),Ke.viewport.set(st.x,st.y,st.width,st.height),pt===0&&(J.matrix.copy(Ke.matrix),J.matrix.decompose(J.position,J.quaternion,J.scale)),He===!0&&J.cameras.push(Ke)}const Ge=l.enabledFeatures;if(Ge&&Ge.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&T){g=r.getBinding();const pt=g.getDepthInformation(Ae[0]);pt&&pt.isValid&&pt.texture&&M.init(pt,l.renderState)}if(Ge&&Ge.includes("camera-access")&&T){t.state.unbindTexture(),g=r.getBinding();for(let pt=0;pt<Ae.length;pt++){const mt=Ae[pt].camera;if(mt){let st=x[mt];st||(st=new Nv,x[mt]=st);const Ke=g.getCameraImage(mt);st.sourceTexture=Ke}}}}for(let Ae=0;Ae<D.length;Ae++){const He=O[Ae],Ge=D[Ae];He!==null&&Ge!==void 0&&Ge.update(He,ae,p||d)}_e&&_e(Q,ae),ae.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ae}),b=null}const be=new Lv;be.setAnimationLoop(de),this.setAnimationLoop=function(Q){_e=Q},this.dispose=function(){}}}const Cr=new ya,gA=new hn;function _A(s,t){function i(M,x){M.matrixAutoUpdate===!0&&M.updateMatrix(),x.value.copy(M.matrix)}function r(M,x){x.color.getRGB(M.fogColor.value,Av(s)),x.isFog?(M.fogNear.value=x.near,M.fogFar.value=x.far):x.isFogExp2&&(M.fogDensity.value=x.density)}function l(M,x,I,U,N){x.isMeshBasicMaterial||x.isMeshLambertMaterial?c(M,x):x.isMeshToonMaterial?(c(M,x),g(M,x)):x.isMeshPhongMaterial?(c(M,x),_(M,x)):x.isMeshStandardMaterial?(c(M,x),v(M,x),x.isMeshPhysicalMaterial&&y(M,x,N)):x.isMeshMatcapMaterial?(c(M,x),b(M,x)):x.isMeshDepthMaterial?c(M,x):x.isMeshDistanceMaterial?(c(M,x),T(M,x)):x.isMeshNormalMaterial?c(M,x):x.isLineBasicMaterial?(d(M,x),x.isLineDashedMaterial&&h(M,x)):x.isPointsMaterial?m(M,x,I,U):x.isSpriteMaterial?p(M,x):x.isShadowMaterial?(M.color.value.copy(x.color),M.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function c(M,x){M.opacity.value=x.opacity,x.color&&M.diffuse.value.copy(x.color),x.emissive&&M.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.bumpMap&&(M.bumpMap.value=x.bumpMap,i(x.bumpMap,M.bumpMapTransform),M.bumpScale.value=x.bumpScale,x.side===Wn&&(M.bumpScale.value*=-1)),x.normalMap&&(M.normalMap.value=x.normalMap,i(x.normalMap,M.normalMapTransform),M.normalScale.value.copy(x.normalScale),x.side===Wn&&M.normalScale.value.negate()),x.displacementMap&&(M.displacementMap.value=x.displacementMap,i(x.displacementMap,M.displacementMapTransform),M.displacementScale.value=x.displacementScale,M.displacementBias.value=x.displacementBias),x.emissiveMap&&(M.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,M.emissiveMapTransform)),x.specularMap&&(M.specularMap.value=x.specularMap,i(x.specularMap,M.specularMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest);const I=t.get(x),U=I.envMap,N=I.envMapRotation;U&&(M.envMap.value=U,Cr.copy(N),Cr.x*=-1,Cr.y*=-1,Cr.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(Cr.y*=-1,Cr.z*=-1),M.envMapRotation.value.setFromMatrix4(gA.makeRotationFromEuler(Cr)),M.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=x.reflectivity,M.ior.value=x.ior,M.refractionRatio.value=x.refractionRatio),x.lightMap&&(M.lightMap.value=x.lightMap,M.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,M.lightMapTransform)),x.aoMap&&(M.aoMap.value=x.aoMap,M.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,M.aoMapTransform))}function d(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform))}function h(M,x){M.dashSize.value=x.dashSize,M.totalSize.value=x.dashSize+x.gapSize,M.scale.value=x.scale}function m(M,x,I,U){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.size.value=x.size*I,M.scale.value=U*.5,x.map&&(M.map.value=x.map,i(x.map,M.uvTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function p(M,x){M.diffuse.value.copy(x.color),M.opacity.value=x.opacity,M.rotation.value=x.rotation,x.map&&(M.map.value=x.map,i(x.map,M.mapTransform)),x.alphaMap&&(M.alphaMap.value=x.alphaMap,i(x.alphaMap,M.alphaMapTransform)),x.alphaTest>0&&(M.alphaTest.value=x.alphaTest)}function _(M,x){M.specular.value.copy(x.specular),M.shininess.value=Math.max(x.shininess,1e-4)}function g(M,x){x.gradientMap&&(M.gradientMap.value=x.gradientMap)}function v(M,x){M.metalness.value=x.metalness,x.metalnessMap&&(M.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,M.metalnessMapTransform)),M.roughness.value=x.roughness,x.roughnessMap&&(M.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,M.roughnessMapTransform)),x.envMap&&(M.envMapIntensity.value=x.envMapIntensity)}function y(M,x,I){M.ior.value=x.ior,x.sheen>0&&(M.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),M.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(M.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,M.sheenColorMapTransform)),x.sheenRoughnessMap&&(M.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,M.sheenRoughnessMapTransform))),x.clearcoat>0&&(M.clearcoat.value=x.clearcoat,M.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(M.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,M.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(M.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Wn&&M.clearcoatNormalScale.value.negate())),x.dispersion>0&&(M.dispersion.value=x.dispersion),x.iridescence>0&&(M.iridescence.value=x.iridescence,M.iridescenceIOR.value=x.iridescenceIOR,M.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(M.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,M.iridescenceMapTransform)),x.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),x.transmission>0&&(M.transmission.value=x.transmission,M.transmissionSamplerMap.value=I.texture,M.transmissionSamplerSize.value.set(I.width,I.height),x.transmissionMap&&(M.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,M.transmissionMapTransform)),M.thickness.value=x.thickness,x.thicknessMap&&(M.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=x.attenuationDistance,M.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(M.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(M.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=x.specularIntensity,M.specularColor.value.copy(x.specularColor),x.specularColorMap&&(M.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,M.specularColorMapTransform)),x.specularIntensityMap&&(M.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,M.specularIntensityMapTransform))}function b(M,x){x.matcap&&(M.matcap.value=x.matcap)}function T(M,x){const I=t.get(x).light;M.referencePosition.value.setFromMatrixPosition(I.matrixWorld),M.nearDistance.value=I.shadow.camera.near,M.farDistance.value=I.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function vA(s,t,i,r){let l={},c={},d=[];const h=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function m(I,U){const N=U.program;r.uniformBlockBinding(I,N)}function p(I,U){let N=l[I.id];N===void 0&&(b(I),N=_(I),l[I.id]=N,I.addEventListener("dispose",M));const D=U.program;r.updateUBOMapping(I,D);const O=t.render.frame;c[I.id]!==O&&(v(I),c[I.id]=O)}function _(I){const U=g();I.__bindingPointIndex=U;const N=s.createBuffer(),D=I.__size,O=I.usage;return s.bindBuffer(s.UNIFORM_BUFFER,N),s.bufferData(s.UNIFORM_BUFFER,D,O),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,U,N),N}function g(){for(let I=0;I<h;I++)if(d.indexOf(I)===-1)return d.push(I),I;return Ut("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(I){const U=l[I.id],N=I.uniforms,D=I.__cache;s.bindBuffer(s.UNIFORM_BUFFER,U);for(let O=0,L=N.length;O<L;O++){const z=Array.isArray(N[O])?N[O]:[N[O]];for(let A=0,C=z.length;A<C;A++){const H=z[A];if(y(H,O,A,D)===!0){const J=H.__offset,q=Array.isArray(H.value)?H.value:[H.value];let ne=0;for(let $=0;$<q.length;$++){const B=q[$],G=T(B);typeof B=="number"||typeof B=="boolean"?(H.__data[0]=B,s.bufferSubData(s.UNIFORM_BUFFER,J+ne,H.__data)):B.isMatrix3?(H.__data[0]=B.elements[0],H.__data[1]=B.elements[1],H.__data[2]=B.elements[2],H.__data[3]=0,H.__data[4]=B.elements[3],H.__data[5]=B.elements[4],H.__data[6]=B.elements[5],H.__data[7]=0,H.__data[8]=B.elements[6],H.__data[9]=B.elements[7],H.__data[10]=B.elements[8],H.__data[11]=0):(B.toArray(H.__data,ne),ne+=G.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,J,H.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function y(I,U,N,D){const O=I.value,L=U+"_"+N;if(D[L]===void 0)return typeof O=="number"||typeof O=="boolean"?D[L]=O:D[L]=O.clone(),!0;{const z=D[L];if(typeof O=="number"||typeof O=="boolean"){if(z!==O)return D[L]=O,!0}else if(z.equals(O)===!1)return z.copy(O),!0}return!1}function b(I){const U=I.uniforms;let N=0;const D=16;for(let L=0,z=U.length;L<z;L++){const A=Array.isArray(U[L])?U[L]:[U[L]];for(let C=0,H=A.length;C<H;C++){const J=A[C],q=Array.isArray(J.value)?J.value:[J.value];for(let ne=0,$=q.length;ne<$;ne++){const B=q[ne],G=T(B),te=N%D,ve=te%G.boundary,ge=te+ve;N+=ve,ge!==0&&D-ge<G.storage&&(N+=D-ge),J.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),J.__offset=N,N+=G.storage}}}const O=N%D;return O>0&&(N+=D-O),I.__size=N,I.__cache={},this}function T(I){const U={boundary:0,storage:0};return typeof I=="number"||typeof I=="boolean"?(U.boundary=4,U.storage=4):I.isVector2?(U.boundary=8,U.storage=8):I.isVector3||I.isColor?(U.boundary=16,U.storage=12):I.isVector4?(U.boundary=16,U.storage=16):I.isMatrix3?(U.boundary=48,U.storage=48):I.isMatrix4?(U.boundary=64,U.storage=64):I.isTexture?dt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):dt("WebGLRenderer: Unsupported uniform value type.",I),U}function M(I){const U=I.target;U.removeEventListener("dispose",M);const N=d.indexOf(U.__bindingPointIndex);d.splice(N,1),s.deleteBuffer(l[U.id]),delete l[U.id],delete c[U.id]}function x(){for(const I in l)s.deleteBuffer(l[I]);d=[],l={},c={}}return{bind:m,update:p,dispose:x}}const xA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Pi=null;function SA(){return Pi===null&&(Pi=new dM(xA,16,16,Is,xa),Pi.name="DFG_LUT",Pi.minFilter=dn,Pi.magFilter=dn,Pi.wrapS=ti,Pi.wrapT=ti,Pi.generateMipmaps=!1,Pi.needsUpdate=!0),Pi}class Bv{constructor(t={}){const{canvas:i=zy(),context:r=null,depth:l=!0,stencil:c=!1,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:v=!1,outputBufferType:y=mi}=t;this.isWebGLRenderer=!0;let b;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=r.getContextAttributes().alpha}else b=d;const T=y,M=new Set([Zh,jh,Yh]),x=new Set([mi,ki,$o,el,Wh,qh]),I=new Uint32Array(4),U=new Int32Array(4);let N=null,D=null;const O=[],L=[];let z=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Hi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const A=this;let C=!1;this._outputColorSpace=pi;let H=0,J=0,q=null,ne=-1,$=null;const B=new rn,G=new rn;let te=null;const ve=new Wt(0);let ge=0,F=i.width,ie=i.height,_e=1,de=null,be=null;const Q=new rn(0,0,F,ie),ae=new rn(0,0,F,ie);let Ae=!1;const He=new Uv;let Ge=!1,ct=!1;const Yt=new hn,pt=new ce,mt=new rn,st={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ke=!1;function et(){return q===null?_e:1}let k=r;function St(w,Z){return i.getContext(w,Z)}try{const w={alpha:!0,depth:l,stencil:c,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:g};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${kh}`),i.addEventListener("webglcontextlost",ot,!1),i.addEventListener("webglcontextrestored",It,!1),i.addEventListener("webglcontextcreationerror",Rt,!1),k===null){const Z="webgl2";if(k=St(Z,w),k===null)throw St(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw Ut("WebGLRenderer: "+w.message),w}let Qe,ut,Ve,P,E,W,pe,ye,he,ke,Re,We,nt,Ee,Ce,Ie,Pe,we,gt,Y,Le,De,ze,Te;function Me(){Qe=new S1(k),Qe.init(),De=new fA(k,Qe),ut=new f1(k,Qe,t,De),Ve=new cA(k,Qe),ut.reversedDepthBuffer&&v&&Ve.buffers.depth.setReversed(!0),P=new E1(k),E=new jT,W=new uA(k,Qe,Ve,E,ut,De,P),pe=new h1(A),ye=new x1(A),he=new RM(k),ze=new c1(k,he),ke=new y1(k,he,P,ze),Re=new T1(k,ke,he,P),gt=new b1(k,ut,W),Ie=new d1(E),We=new YT(A,pe,ye,Qe,ut,ze,Ie),nt=new _A(A,E),Ee=new KT,Ce=new nA(Qe),we=new l1(A,pe,ye,Ve,Re,b,m),Pe=new oA(A,Re,ut),Te=new vA(k,P,ut,Ve),Y=new u1(k,Qe,P),Le=new M1(k,Qe,P),P.programs=We.programs,A.capabilities=ut,A.extensions=Qe,A.properties=E,A.renderLists=Ee,A.shadowMap=Pe,A.state=Ve,A.info=P}Me(),T!==mi&&(z=new R1(T,i.width,i.height,l,c));const Ue=new mA(A,k);this.xr=Ue,this.getContext=function(){return k},this.getContextAttributes=function(){return k.getContextAttributes()},this.forceContextLoss=function(){const w=Qe.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Qe.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(w){w!==void 0&&(_e=w,this.setSize(F,ie,!1))},this.getSize=function(w){return w.set(F,ie)},this.setSize=function(w,Z,ue=!0){if(Ue.isPresenting){dt("WebGLRenderer: Can't change size while VR device is presenting.");return}F=w,ie=Z,i.width=Math.floor(w*_e),i.height=Math.floor(Z*_e),ue===!0&&(i.style.width=w+"px",i.style.height=Z+"px"),z!==null&&z.setSize(i.width,i.height),this.setViewport(0,0,w,Z)},this.getDrawingBufferSize=function(w){return w.set(F*_e,ie*_e).floor()},this.setDrawingBufferSize=function(w,Z,ue){F=w,ie=Z,_e=ue,i.width=Math.floor(w*ue),i.height=Math.floor(Z*ue),this.setViewport(0,0,w,Z)},this.setEffects=function(w){if(T===mi){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(w){for(let Z=0;Z<w.length;Z++)if(w[Z].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}z.setEffects(w||[])},this.getCurrentViewport=function(w){return w.copy(B)},this.getViewport=function(w){return w.copy(Q)},this.setViewport=function(w,Z,ue,oe){w.isVector4?Q.set(w.x,w.y,w.z,w.w):Q.set(w,Z,ue,oe),Ve.viewport(B.copy(Q).multiplyScalar(_e).round())},this.getScissor=function(w){return w.copy(ae)},this.setScissor=function(w,Z,ue,oe){w.isVector4?ae.set(w.x,w.y,w.z,w.w):ae.set(w,Z,ue,oe),Ve.scissor(G.copy(ae).multiplyScalar(_e).round())},this.getScissorTest=function(){return Ae},this.setScissorTest=function(w){Ve.setScissorTest(Ae=w)},this.setOpaqueSort=function(w){de=w},this.setTransparentSort=function(w){be=w},this.getClearColor=function(w){return w.copy(we.getClearColor())},this.setClearColor=function(){we.setClearColor(...arguments)},this.getClearAlpha=function(){return we.getClearAlpha()},this.setClearAlpha=function(){we.setClearAlpha(...arguments)},this.clear=function(w=!0,Z=!0,ue=!0){let oe=0;if(w){let ee=!1;if(q!==null){const Ne=q.texture.format;ee=M.has(Ne)}if(ee){const Ne=q.texture.type,Xe=x.has(Ne),Oe=we.getClearColor(),qe=we.getClearAlpha(),je=Oe.r,it=Oe.g,Ze=Oe.b;Xe?(I[0]=je,I[1]=it,I[2]=Ze,I[3]=qe,k.clearBufferuiv(k.COLOR,0,I)):(U[0]=je,U[1]=it,U[2]=Ze,U[3]=qe,k.clearBufferiv(k.COLOR,0,U))}else oe|=k.COLOR_BUFFER_BIT}Z&&(oe|=k.DEPTH_BUFFER_BIT),ue&&(oe|=k.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k.clear(oe)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",ot,!1),i.removeEventListener("webglcontextrestored",It,!1),i.removeEventListener("webglcontextcreationerror",Rt,!1),we.dispose(),Ee.dispose(),Ce.dispose(),E.dispose(),pe.dispose(),ye.dispose(),Re.dispose(),ze.dispose(),Te.dispose(),We.dispose(),Ue.dispose(),Ue.removeEventListener("sessionstart",Fr),Ue.removeEventListener("sessionend",Ws),Di.stop()};function ot(w){w.preventDefault(),Jg("WebGLRenderer: Context Lost."),C=!0}function It(){Jg("WebGLRenderer: Context Restored."),C=!1;const w=P.autoReset,Z=Pe.enabled,ue=Pe.autoUpdate,oe=Pe.needsUpdate,ee=Pe.type;Me(),P.autoReset=w,Pe.enabled=Z,Pe.autoUpdate=ue,Pe.needsUpdate=oe,Pe.type=ee}function Rt(w){Ut("WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Nn(w){const Z=w.target;Z.removeEventListener("dispose",Nn),_i(Z)}function _i(w){ul(w),E.remove(w)}function ul(w){const Z=E.get(w).programs;Z!==void 0&&(Z.forEach(function(ue){We.releaseProgram(ue)}),w.isShaderMaterial&&We.releaseShaderCache(w))}this.renderBufferDirect=function(w,Z,ue,oe,ee,Ne){Z===null&&(Z=st);const Xe=ee.isMesh&&ee.matrixWorld.determinant()<0,Oe=rr(w,Z,ue,oe,ee);Ve.setMaterial(oe,Xe);let qe=ue.index,je=1;if(oe.wireframe===!0){if(qe=ke.getWireframeAttribute(ue),qe===void 0)return;je=2}const it=ue.drawRange,Ze=ue.attributes.position;let at=it.start*je,Lt=(it.start+it.count)*je;Ne!==null&&(at=Math.max(at,Ne.start*je),Lt=Math.min(Lt,(Ne.start+Ne.count)*je)),qe!==null?(at=Math.max(at,0),Lt=Math.min(Lt,qe.count)):Ze!=null&&(at=Math.max(at,0),Lt=Math.min(Lt,Ze.count));const Qt=Lt-at;if(Qt<0||Qt===1/0)return;ze.setup(ee,oe,Oe,ue,qe);let jt,Ft=Y;if(qe!==null&&(jt=he.get(qe),Ft=Le,Ft.setIndex(jt)),ee.isMesh)oe.wireframe===!0?(Ve.setLineWidth(oe.wireframeLinewidth*et()),Ft.setMode(k.LINES)):Ft.setMode(k.TRIANGLES);else if(ee.isLine){let $e=oe.linewidth;$e===void 0&&($e=1),Ve.setLineWidth($e*et()),ee.isLineSegments?Ft.setMode(k.LINES):ee.isLineLoop?Ft.setMode(k.LINE_LOOP):Ft.setMode(k.LINE_STRIP)}else ee.isPoints?Ft.setMode(k.POINTS):ee.isSprite&&Ft.setMode(k.TRIANGLES);if(ee.isBatchedMesh)if(ee._multiDrawInstances!==null)nl("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ft.renderMultiDrawInstances(ee._multiDrawStarts,ee._multiDrawCounts,ee._multiDrawCount,ee._multiDrawInstances);else if(Qe.get("WEBGL_multi_draw"))Ft.renderMultiDraw(ee._multiDrawStarts,ee._multiDrawCounts,ee._multiDrawCount);else{const $e=ee._multiDrawStarts,Ot=ee._multiDrawCounts,lt=ee._multiDrawCount,yn=qe?he.get(qe).bytesPerElement:1,Xi=E.get(oe).currentProgram.getUniforms();for(let Mn=0;Mn<lt;Mn++)Xi.setValue(k,"_gl_DrawID",Mn),Ft.render($e[Mn]/yn,Ot[Mn])}else if(ee.isInstancedMesh)Ft.renderInstances(at,Qt,ee.count);else if(ue.isInstancedBufferGeometry){const $e=ue._maxInstanceCount!==void 0?ue._maxInstanceCount:1/0,Ot=Math.min(ue.instanceCount,$e);Ft.renderInstances(at,Qt,Ot)}else Ft.render(at,Qt)};function ks(w,Z,ue){w.transparent===!0&&w.side===Ii&&w.forceSinglePass===!1?(w.side=Wn,w.needsUpdate=!0,Br(w,Z,ue),w.side=ar,w.needsUpdate=!0,Br(w,Z,ue),w.side=Ii):Br(w,Z,ue)}this.compile=function(w,Z,ue=null){ue===null&&(ue=w),D=Ce.get(ue),D.init(Z),L.push(D),ue.traverseVisible(function(ee){ee.isLight&&ee.layers.test(Z.layers)&&(D.pushLight(ee),ee.castShadow&&D.pushShadow(ee))}),w!==ue&&w.traverseVisible(function(ee){ee.isLight&&ee.layers.test(Z.layers)&&(D.pushLight(ee),ee.castShadow&&D.pushShadow(ee))}),D.setupLights();const oe=new Set;return w.traverse(function(ee){if(!(ee.isMesh||ee.isPoints||ee.isLine||ee.isSprite))return;const Ne=ee.material;if(Ne)if(Array.isArray(Ne))for(let Xe=0;Xe<Ne.length;Xe++){const Oe=Ne[Xe];ks(Oe,ue,ee),oe.add(Oe)}else ks(Ne,ue,ee),oe.add(Ne)}),D=L.pop(),oe},this.compileAsync=function(w,Z,ue=null){const oe=this.compile(w,Z,ue);return new Promise(ee=>{function Ne(){if(oe.forEach(function(Xe){E.get(Xe).currentProgram.isReady()&&oe.delete(Xe)}),oe.size===0){ee(w);return}setTimeout(Ne,10)}Qe.get("KHR_parallel_shader_compile")!==null?Ne():setTimeout(Ne,10)})};let Pr=null;function Xs(w){Pr&&Pr(w)}function Fr(){Di.stop()}function Ws(){Di.start()}const Di=new Lv;Di.setAnimationLoop(Xs),typeof self<"u"&&Di.setContext(self),this.setAnimationLoop=function(w){Pr=w,Ue.setAnimationLoop(w),w===null?Di.stop():Di.start()},Ue.addEventListener("sessionstart",Fr),Ue.addEventListener("sessionend",Ws),this.render=function(w,Z){if(Z!==void 0&&Z.isCamera!==!0){Ut("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;const ue=Ue.enabled===!0&&Ue.isPresenting===!0,oe=z!==null&&(q===null||ue)&&z.begin(A,q);if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),Ue.enabled===!0&&Ue.isPresenting===!0&&(z===null||z.isCompositing()===!1)&&(Ue.cameraAutoUpdate===!0&&Ue.updateCamera(Z),Z=Ue.getCamera()),w.isScene===!0&&w.onBeforeRender(A,w,Z,q),D=Ce.get(w,L.length),D.init(Z),L.push(D),Yt.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),He.setFromProjectionMatrix(Yt,zi,Z.reversedDepth),ct=this.localClippingEnabled,Ge=Ie.init(this.clippingPlanes,ct),N=Ee.get(w,O.length),N.init(),O.push(N),Ue.enabled===!0&&Ue.isPresenting===!0){const Xe=A.xr.getDepthSensingMesh();Xe!==null&&ii(Xe,Z,-1/0,A.sortObjects)}ii(w,Z,0,A.sortObjects),N.finish(),A.sortObjects===!0&&N.sort(de,be),Ke=Ue.enabled===!1||Ue.isPresenting===!1||Ue.hasDepthSensing()===!1,Ke&&we.addToRenderList(N,w),this.info.render.frame++,Ge===!0&&Ie.beginShadows();const ee=D.state.shadowsArray;if(Pe.render(ee,w,Z),Ge===!0&&Ie.endShadows(),this.info.autoReset===!0&&this.info.reset(),(oe&&z.hasRenderPass())===!1){const Xe=N.opaque,Oe=N.transmissive;if(D.setupLights(),Z.isArrayCamera){const qe=Z.cameras;if(Oe.length>0)for(let je=0,it=qe.length;je<it;je++){const Ze=qe[je];Sn(Xe,Oe,w,Ze)}Ke&&we.render(w);for(let je=0,it=qe.length;je<it;je++){const Ze=qe[je];sn(N,w,Ze,Ze.viewport)}}else Oe.length>0&&Sn(Xe,Oe,w,Z),Ke&&we.render(w),sn(N,w,Z)}q!==null&&J===0&&(W.updateMultisampleRenderTarget(q),W.updateRenderTargetMipmap(q)),oe&&z.end(A),w.isScene===!0&&w.onAfterRender(A,w,Z),ze.resetDefaultState(),ne=-1,$=null,L.pop(),L.length>0?(D=L[L.length-1],Ge===!0&&Ie.setGlobalState(A.clippingPlanes,D.state.camera)):D=null,O.pop(),O.length>0?N=O[O.length-1]:N=null};function ii(w,Z,ue,oe){if(w.visible===!1)return;if(w.layers.test(Z.layers)){if(w.isGroup)ue=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(Z);else if(w.isLight)D.pushLight(w),w.castShadow&&D.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||He.intersectsSprite(w)){oe&&mt.setFromMatrixPosition(w.matrixWorld).applyMatrix4(Yt);const Xe=Re.update(w),Oe=w.material;Oe.visible&&N.push(w,Xe,Oe,ue,mt.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||He.intersectsObject(w))){const Xe=Re.update(w),Oe=w.material;if(oe&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),mt.copy(w.boundingSphere.center)):(Xe.boundingSphere===null&&Xe.computeBoundingSphere(),mt.copy(Xe.boundingSphere.center)),mt.applyMatrix4(w.matrixWorld).applyMatrix4(Yt)),Array.isArray(Oe)){const qe=Xe.groups;for(let je=0,it=qe.length;je<it;je++){const Ze=qe[je],at=Oe[Ze.materialIndex];at&&at.visible&&N.push(w,Xe,at,ue,mt.z,Ze)}}else Oe.visible&&N.push(w,Xe,Oe,ue,mt.z,null)}}const Ne=w.children;for(let Xe=0,Oe=Ne.length;Xe<Oe;Xe++)ii(Ne[Xe],Z,ue,oe)}function sn(w,Z,ue,oe){const{opaque:ee,transmissive:Ne,transparent:Xe}=w;D.setupLightsView(ue),Ge===!0&&Ie.setGlobalState(A.clippingPlanes,ue),oe&&Ve.viewport(B.copy(oe)),ee.length>0&&vi(ee,Z,ue),Ne.length>0&&vi(Ne,Z,ue),Xe.length>0&&vi(Xe,Z,ue),Ve.buffers.depth.setTest(!0),Ve.buffers.depth.setMask(!0),Ve.buffers.color.setMask(!0),Ve.setPolygonOffset(!1)}function Sn(w,Z,ue,oe){if((ue.isScene===!0?ue.overrideMaterial:null)!==null)return;if(D.state.transmissionRenderTarget[oe.id]===void 0){const at=Qe.has("EXT_color_buffer_half_float")||Qe.has("EXT_color_buffer_float");D.state.transmissionRenderTarget[oe.id]=new Gi(1,1,{generateMipmaps:!0,type:at?xa:mi,minFilter:Nr,samples:ut.samples,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ct.workingColorSpace})}const Ne=D.state.transmissionRenderTarget[oe.id],Xe=oe.viewport||B;Ne.setSize(Xe.z*A.transmissionResolutionScale,Xe.w*A.transmissionResolutionScale);const Oe=A.getRenderTarget(),qe=A.getActiveCubeFace(),je=A.getActiveMipmapLevel();A.setRenderTarget(Ne),A.getClearColor(ve),ge=A.getClearAlpha(),ge<1&&A.setClearColor(16777215,.5),A.clear(),Ke&&we.render(ue);const it=A.toneMapping;A.toneMapping=Hi;const Ze=oe.viewport;if(oe.viewport!==void 0&&(oe.viewport=void 0),D.setupLightsView(oe),Ge===!0&&Ie.setGlobalState(A.clippingPlanes,oe),vi(w,ue,oe),W.updateMultisampleRenderTarget(Ne),W.updateRenderTargetMipmap(Ne),Qe.has("WEBGL_multisampled_render_to_texture")===!1){let at=!1;for(let Lt=0,Qt=Z.length;Lt<Qt;Lt++){const jt=Z[Lt],{object:Ft,geometry:$e,material:Ot,group:lt}=jt;if(Ot.side===Ii&&Ft.layers.test(oe.layers)){const yn=Ot.side;Ot.side=Wn,Ot.needsUpdate=!0,Ir(Ft,ue,oe,$e,Ot,lt),Ot.side=yn,Ot.needsUpdate=!0,at=!0}}at===!0&&(W.updateMultisampleRenderTarget(Ne),W.updateRenderTargetMipmap(Ne))}A.setRenderTarget(Oe,qe,je),A.setClearColor(ve,ge),Ze!==void 0&&(oe.viewport=Ze),A.toneMapping=it}function vi(w,Z,ue){const oe=Z.isScene===!0?Z.overrideMaterial:null;for(let ee=0,Ne=w.length;ee<Ne;ee++){const Xe=w[ee],{object:Oe,geometry:qe,group:je}=Xe;let it=Xe.material;it.allowOverride===!0&&oe!==null&&(it=oe),Oe.layers.test(ue.layers)&&Ir(Oe,Z,ue,qe,it,je)}}function Ir(w,Z,ue,oe,ee,Ne){w.onBeforeRender(A,Z,ue,oe,ee,Ne),w.modelViewMatrix.multiplyMatrices(ue.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),ee.onBeforeRender(A,Z,ue,oe,w,Ne),ee.transparent===!0&&ee.side===Ii&&ee.forceSinglePass===!1?(ee.side=Wn,ee.needsUpdate=!0,A.renderBufferDirect(ue,Z,oe,ee,w,Ne),ee.side=ar,ee.needsUpdate=!0,A.renderBufferDirect(ue,Z,oe,ee,w,Ne),ee.side=Ii):A.renderBufferDirect(ue,Z,oe,ee,w,Ne),w.onAfterRender(A,Z,ue,oe,ee,Ne)}function Br(w,Z,ue){Z.isScene!==!0&&(Z=st);const oe=E.get(w),ee=D.state.lights,Ne=D.state.shadowsArray,Xe=ee.state.version,Oe=We.getParameters(w,ee.state,Ne,Z,ue),qe=We.getProgramCacheKey(Oe);let je=oe.programs;oe.environment=w.isMeshStandardMaterial?Z.environment:null,oe.fog=Z.fog,oe.envMap=(w.isMeshStandardMaterial?ye:pe).get(w.envMap||oe.environment),oe.envMapRotation=oe.environment!==null&&w.envMap===null?Z.environmentRotation:w.envMapRotation,je===void 0&&(w.addEventListener("dispose",Nn),je=new Map,oe.programs=je);let it=je.get(qe);if(it!==void 0){if(oe.currentProgram===it&&oe.lightsStateVersion===Xe)return qs(w,Oe),it}else Oe.uniforms=We.getUniforms(w),w.onBeforeCompile(Oe,A),it=We.acquireProgram(Oe,qe),je.set(qe,it),oe.uniforms=Oe.uniforms;const Ze=oe.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Ze.clippingPlanes=Ie.uniform),qs(w,Oe),oe.needsLights=Ea(w),oe.lightsStateVersion=Xe,oe.needsLights&&(Ze.ambientLightColor.value=ee.state.ambient,Ze.lightProbe.value=ee.state.probe,Ze.directionalLights.value=ee.state.directional,Ze.directionalLightShadows.value=ee.state.directionalShadow,Ze.spotLights.value=ee.state.spot,Ze.spotLightShadows.value=ee.state.spotShadow,Ze.rectAreaLights.value=ee.state.rectArea,Ze.ltc_1.value=ee.state.rectAreaLTC1,Ze.ltc_2.value=ee.state.rectAreaLTC2,Ze.pointLights.value=ee.state.point,Ze.pointLightShadows.value=ee.state.pointShadow,Ze.hemisphereLights.value=ee.state.hemi,Ze.directionalShadowMap.value=ee.state.directionalShadowMap,Ze.directionalShadowMatrix.value=ee.state.directionalShadowMatrix,Ze.spotShadowMap.value=ee.state.spotShadowMap,Ze.spotLightMatrix.value=ee.state.spotLightMatrix,Ze.spotLightMap.value=ee.state.spotLightMap,Ze.pointShadowMap.value=ee.state.pointShadowMap,Ze.pointShadowMatrix.value=ee.state.pointShadowMatrix),oe.currentProgram=it,oe.uniformsList=null,it}function fl(w){if(w.uniformsList===null){const Z=w.currentProgram.getUniforms();w.uniformsList=Yc.seqWithValue(Z.seq,w.uniforms)}return w.uniformsList}function qs(w,Z){const ue=E.get(w);ue.outputColorSpace=Z.outputColorSpace,ue.batching=Z.batching,ue.batchingColor=Z.batchingColor,ue.instancing=Z.instancing,ue.instancingColor=Z.instancingColor,ue.instancingMorph=Z.instancingMorph,ue.skinning=Z.skinning,ue.morphTargets=Z.morphTargets,ue.morphNormals=Z.morphNormals,ue.morphColors=Z.morphColors,ue.morphTargetsCount=Z.morphTargetsCount,ue.numClippingPlanes=Z.numClippingPlanes,ue.numIntersection=Z.numClipIntersection,ue.vertexAlphas=Z.vertexAlphas,ue.vertexTangents=Z.vertexTangents,ue.toneMapping=Z.toneMapping}function rr(w,Z,ue,oe,ee){Z.isScene!==!0&&(Z=st),W.resetTextureUnits();const Ne=Z.fog,Xe=oe.isMeshStandardMaterial?Z.environment:null,Oe=q===null?A.outputColorSpace:q.isXRRenderTarget===!0?q.texture.colorSpace:Bs,qe=(oe.isMeshStandardMaterial?ye:pe).get(oe.envMap||Xe),je=oe.vertexColors===!0&&!!ue.attributes.color&&ue.attributes.color.itemSize===4,it=!!ue.attributes.tangent&&(!!oe.normalMap||oe.anisotropy>0),Ze=!!ue.morphAttributes.position,at=!!ue.morphAttributes.normal,Lt=!!ue.morphAttributes.color;let Qt=Hi;oe.toneMapped&&(q===null||q.isXRRenderTarget===!0)&&(Qt=A.toneMapping);const jt=ue.morphAttributes.position||ue.morphAttributes.normal||ue.morphAttributes.color,Ft=jt!==void 0?jt.length:0,$e=E.get(oe),Ot=D.state.lights;if(Ge===!0&&(ct===!0||w!==$)){const bn=w===$&&oe.id===ne;Ie.setState(oe,w,bn)}let lt=!1;oe.version===$e.__version?($e.needsLights&&$e.lightsStateVersion!==Ot.state.version||$e.outputColorSpace!==Oe||ee.isBatchedMesh&&$e.batching===!1||!ee.isBatchedMesh&&$e.batching===!0||ee.isBatchedMesh&&$e.batchingColor===!0&&ee.colorTexture===null||ee.isBatchedMesh&&$e.batchingColor===!1&&ee.colorTexture!==null||ee.isInstancedMesh&&$e.instancing===!1||!ee.isInstancedMesh&&$e.instancing===!0||ee.isSkinnedMesh&&$e.skinning===!1||!ee.isSkinnedMesh&&$e.skinning===!0||ee.isInstancedMesh&&$e.instancingColor===!0&&ee.instanceColor===null||ee.isInstancedMesh&&$e.instancingColor===!1&&ee.instanceColor!==null||ee.isInstancedMesh&&$e.instancingMorph===!0&&ee.morphTexture===null||ee.isInstancedMesh&&$e.instancingMorph===!1&&ee.morphTexture!==null||$e.envMap!==qe||oe.fog===!0&&$e.fog!==Ne||$e.numClippingPlanes!==void 0&&($e.numClippingPlanes!==Ie.numPlanes||$e.numIntersection!==Ie.numIntersection)||$e.vertexAlphas!==je||$e.vertexTangents!==it||$e.morphTargets!==Ze||$e.morphNormals!==at||$e.morphColors!==Lt||$e.toneMapping!==Qt||$e.morphTargetsCount!==Ft)&&(lt=!0):(lt=!0,$e.__version=oe.version);let yn=$e.currentProgram;lt===!0&&(yn=Br(oe,Z,ee));let Xi=!1,Mn=!1,ai=!1;const Bt=yn.getUniforms(),En=$e.uniforms;if(Ve.useProgram(yn.program)&&(Xi=!0,Mn=!0,ai=!0),oe.id!==ne&&(ne=oe.id,Mn=!0),Xi||$!==w){Ve.buffers.depth.getReversed()&&w.reversedDepth!==!0&&(w._reversedDepth=!0,w.updateProjectionMatrix()),Bt.setValue(k,"projectionMatrix",w.projectionMatrix),Bt.setValue(k,"viewMatrix",w.matrixWorldInverse);const Tn=Bt.map.cameraPosition;Tn!==void 0&&Tn.setValue(k,pt.setFromMatrixPosition(w.matrixWorld)),ut.logarithmicDepthBuffer&&Bt.setValue(k,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(oe.isMeshPhongMaterial||oe.isMeshToonMaterial||oe.isMeshLambertMaterial||oe.isMeshBasicMaterial||oe.isMeshStandardMaterial||oe.isShaderMaterial)&&Bt.setValue(k,"isOrthographic",w.isOrthographicCamera===!0),$!==w&&($=w,Mn=!0,ai=!0)}if($e.needsLights&&(Ot.state.directionalShadowMap.length>0&&Bt.setValue(k,"directionalShadowMap",Ot.state.directionalShadowMap,W),Ot.state.spotShadowMap.length>0&&Bt.setValue(k,"spotShadowMap",Ot.state.spotShadowMap,W),Ot.state.pointShadowMap.length>0&&Bt.setValue(k,"pointShadowMap",Ot.state.pointShadowMap,W)),ee.isSkinnedMesh){Bt.setOptional(k,ee,"bindMatrix"),Bt.setOptional(k,ee,"bindMatrixInverse");const bn=ee.skeleton;bn&&(bn.boneTexture===null&&bn.computeBoneTexture(),Bt.setValue(k,"boneTexture",bn.boneTexture,W))}ee.isBatchedMesh&&(Bt.setOptional(k,ee,"batchingTexture"),Bt.setValue(k,"batchingTexture",ee._matricesTexture,W),Bt.setOptional(k,ee,"batchingIdTexture"),Bt.setValue(k,"batchingIdTexture",ee._indirectTexture,W),Bt.setOptional(k,ee,"batchingColorTexture"),ee._colorsTexture!==null&&Bt.setValue(k,"batchingColorTexture",ee._colorsTexture,W));const pn=ue.morphAttributes;if((pn.position!==void 0||pn.normal!==void 0||pn.color!==void 0)&&gt.update(ee,ue,yn),(Mn||$e.receiveShadow!==ee.receiveShadow)&&($e.receiveShadow=ee.receiveShadow,Bt.setValue(k,"receiveShadow",ee.receiveShadow)),oe.isMeshGouraudMaterial&&oe.envMap!==null&&(En.envMap.value=qe,En.flipEnvMap.value=qe.isCubeTexture&&qe.isRenderTargetTexture===!1?-1:1),oe.isMeshStandardMaterial&&oe.envMap===null&&Z.environment!==null&&(En.envMapIntensity.value=Z.environmentIntensity),En.dfgLUT!==void 0&&(En.dfgLUT.value=SA()),Mn&&(Bt.setValue(k,"toneMappingExposure",A.toneMappingExposure),$e.needsLights&&Ys(En,ai),Ne&&oe.fog===!0&&nt.refreshFogUniforms(En,Ne),nt.refreshMaterialUniforms(En,oe,_e,ie,D.state.transmissionRenderTarget[w.id]),Yc.upload(k,fl($e),En,W)),oe.isShaderMaterial&&oe.uniformsNeedUpdate===!0&&(Yc.upload(k,fl($e),En,W),oe.uniformsNeedUpdate=!1),oe.isSpriteMaterial&&Bt.setValue(k,"center",ee.center),Bt.setValue(k,"modelViewMatrix",ee.modelViewMatrix),Bt.setValue(k,"normalMatrix",ee.normalMatrix),Bt.setValue(k,"modelMatrix",ee.matrixWorld),oe.isShaderMaterial||oe.isRawShaderMaterial){const bn=oe.uniformsGroups;for(let Tn=0,zr=bn.length;Tn<zr;Tn++){const xi=bn[Tn];Te.update(xi,yn),Te.bind(xi,yn)}}return yn}function Ys(w,Z){w.ambientLightColor.needsUpdate=Z,w.lightProbe.needsUpdate=Z,w.directionalLights.needsUpdate=Z,w.directionalLightShadows.needsUpdate=Z,w.pointLights.needsUpdate=Z,w.pointLightShadows.needsUpdate=Z,w.spotLights.needsUpdate=Z,w.spotLightShadows.needsUpdate=Z,w.rectAreaLights.needsUpdate=Z,w.hemisphereLights.needsUpdate=Z}function Ea(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return H},this.getActiveMipmapLevel=function(){return J},this.getRenderTarget=function(){return q},this.setRenderTargetTextures=function(w,Z,ue){const oe=E.get(w);oe.__autoAllocateDepthBuffer=w.resolveDepthBuffer===!1,oe.__autoAllocateDepthBuffer===!1&&(oe.__useRenderToTexture=!1),E.get(w.texture).__webglTexture=Z,E.get(w.depthTexture).__webglTexture=oe.__autoAllocateDepthBuffer?void 0:ue,oe.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(w,Z){const ue=E.get(w);ue.__webglFramebuffer=Z,ue.__useDefaultFramebuffer=Z===void 0};const ba=k.createFramebuffer();this.setRenderTarget=function(w,Z=0,ue=0){q=w,H=Z,J=ue;let oe=null,ee=!1,Ne=!1;if(w){const Oe=E.get(w);if(Oe.__useDefaultFramebuffer!==void 0){Ve.bindFramebuffer(k.FRAMEBUFFER,Oe.__webglFramebuffer),B.copy(w.viewport),G.copy(w.scissor),te=w.scissorTest,Ve.viewport(B),Ve.scissor(G),Ve.setScissorTest(te),ne=-1;return}else if(Oe.__webglFramebuffer===void 0)W.setupRenderTarget(w);else if(Oe.__hasExternalTextures)W.rebindTextures(w,E.get(w.texture).__webglTexture,E.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const it=w.depthTexture;if(Oe.__boundDepthTexture!==it){if(it!==null&&E.has(it)&&(w.width!==it.image.width||w.height!==it.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");W.setupDepthRenderbuffer(w)}}const qe=w.texture;(qe.isData3DTexture||qe.isDataArrayTexture||qe.isCompressedArrayTexture)&&(Ne=!0);const je=E.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(je[Z])?oe=je[Z][ue]:oe=je[Z],ee=!0):w.samples>0&&W.useMultisampledRTT(w)===!1?oe=E.get(w).__webglMultisampledFramebuffer:Array.isArray(je)?oe=je[ue]:oe=je,B.copy(w.viewport),G.copy(w.scissor),te=w.scissorTest}else B.copy(Q).multiplyScalar(_e).floor(),G.copy(ae).multiplyScalar(_e).floor(),te=Ae;if(ue!==0&&(oe=ba),Ve.bindFramebuffer(k.FRAMEBUFFER,oe)&&Ve.drawBuffers(w,oe),Ve.viewport(B),Ve.scissor(G),Ve.setScissorTest(te),ee){const Oe=E.get(w.texture);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,k.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Oe.__webglTexture,ue)}else if(Ne){const Oe=Z;for(let qe=0;qe<w.textures.length;qe++){const je=E.get(w.textures[qe]);k.framebufferTextureLayer(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0+qe,je.__webglTexture,ue,Oe)}}else if(w!==null&&ue!==0){const Oe=E.get(w.texture);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,k.TEXTURE_2D,Oe.__webglTexture,ue)}ne=-1},this.readRenderTargetPixels=function(w,Z,ue,oe,ee,Ne,Xe,Oe=0){if(!(w&&w.isWebGLRenderTarget)){Ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let qe=E.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Xe!==void 0&&(qe=qe[Xe]),qe){Ve.bindFramebuffer(k.FRAMEBUFFER,qe);try{const je=w.textures[Oe],it=je.format,Ze=je.type;if(!ut.textureFormatReadable(it)){Ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ut.textureTypeReadable(Ze)){Ut("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=w.width-oe&&ue>=0&&ue<=w.height-ee&&(w.textures.length>1&&k.readBuffer(k.COLOR_ATTACHMENT0+Oe),k.readPixels(Z,ue,oe,ee,De.convert(it),De.convert(Ze),Ne))}finally{const je=q!==null?E.get(q).__webglFramebuffer:null;Ve.bindFramebuffer(k.FRAMEBUFFER,je)}}},this.readRenderTargetPixelsAsync=async function(w,Z,ue,oe,ee,Ne,Xe,Oe=0){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let qe=E.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Xe!==void 0&&(qe=qe[Xe]),qe)if(Z>=0&&Z<=w.width-oe&&ue>=0&&ue<=w.height-ee){Ve.bindFramebuffer(k.FRAMEBUFFER,qe);const je=w.textures[Oe],it=je.format,Ze=je.type;if(!ut.textureFormatReadable(it))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ut.textureTypeReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const at=k.createBuffer();k.bindBuffer(k.PIXEL_PACK_BUFFER,at),k.bufferData(k.PIXEL_PACK_BUFFER,Ne.byteLength,k.STREAM_READ),w.textures.length>1&&k.readBuffer(k.COLOR_ATTACHMENT0+Oe),k.readPixels(Z,ue,oe,ee,De.convert(it),De.convert(Ze),0);const Lt=q!==null?E.get(q).__webglFramebuffer:null;Ve.bindFramebuffer(k.FRAMEBUFFER,Lt);const Qt=k.fenceSync(k.SYNC_GPU_COMMANDS_COMPLETE,0);return k.flush(),await Hy(k,Qt,4),k.bindBuffer(k.PIXEL_PACK_BUFFER,at),k.getBufferSubData(k.PIXEL_PACK_BUFFER,0,Ne),k.deleteBuffer(at),k.deleteSync(Qt),Ne}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(w,Z=null,ue=0){const oe=Math.pow(2,-ue),ee=Math.floor(w.image.width*oe),Ne=Math.floor(w.image.height*oe),Xe=Z!==null?Z.x:0,Oe=Z!==null?Z.y:0;W.setTexture2D(w,0),k.copyTexSubImage2D(k.TEXTURE_2D,ue,0,0,Xe,Oe,ee,Ne),Ve.unbindTexture()};const sr=k.createFramebuffer(),Ta=k.createFramebuffer();this.copyTextureToTexture=function(w,Z,ue=null,oe=null,ee=0,Ne=null){Ne===null&&(ee!==0?(nl("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Ne=ee,ee=0):Ne=0);let Xe,Oe,qe,je,it,Ze,at,Lt,Qt;const jt=w.isCompressedTexture?w.mipmaps[Ne]:w.image;if(ue!==null)Xe=ue.max.x-ue.min.x,Oe=ue.max.y-ue.min.y,qe=ue.isBox3?ue.max.z-ue.min.z:1,je=ue.min.x,it=ue.min.y,Ze=ue.isBox3?ue.min.z:0;else{const pn=Math.pow(2,-ee);Xe=Math.floor(jt.width*pn),Oe=Math.floor(jt.height*pn),w.isDataArrayTexture?qe=jt.depth:w.isData3DTexture?qe=Math.floor(jt.depth*pn):qe=1,je=0,it=0,Ze=0}oe!==null?(at=oe.x,Lt=oe.y,Qt=oe.z):(at=0,Lt=0,Qt=0);const Ft=De.convert(Z.format),$e=De.convert(Z.type);let Ot;Z.isData3DTexture?(W.setTexture3D(Z,0),Ot=k.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(W.setTexture2DArray(Z,0),Ot=k.TEXTURE_2D_ARRAY):(W.setTexture2D(Z,0),Ot=k.TEXTURE_2D),k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,Z.flipY),k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),k.pixelStorei(k.UNPACK_ALIGNMENT,Z.unpackAlignment);const lt=k.getParameter(k.UNPACK_ROW_LENGTH),yn=k.getParameter(k.UNPACK_IMAGE_HEIGHT),Xi=k.getParameter(k.UNPACK_SKIP_PIXELS),Mn=k.getParameter(k.UNPACK_SKIP_ROWS),ai=k.getParameter(k.UNPACK_SKIP_IMAGES);k.pixelStorei(k.UNPACK_ROW_LENGTH,jt.width),k.pixelStorei(k.UNPACK_IMAGE_HEIGHT,jt.height),k.pixelStorei(k.UNPACK_SKIP_PIXELS,je),k.pixelStorei(k.UNPACK_SKIP_ROWS,it),k.pixelStorei(k.UNPACK_SKIP_IMAGES,Ze);const Bt=w.isDataArrayTexture||w.isData3DTexture,En=Z.isDataArrayTexture||Z.isData3DTexture;if(w.isDepthTexture){const pn=E.get(w),bn=E.get(Z),Tn=E.get(pn.__renderTarget),zr=E.get(bn.__renderTarget);Ve.bindFramebuffer(k.READ_FRAMEBUFFER,Tn.__webglFramebuffer),Ve.bindFramebuffer(k.DRAW_FRAMEBUFFER,zr.__webglFramebuffer);for(let xi=0;xi<qe;xi++)Bt&&(k.framebufferTextureLayer(k.READ_FRAMEBUFFER,k.COLOR_ATTACHMENT0,E.get(w).__webglTexture,ee,Ze+xi),k.framebufferTextureLayer(k.DRAW_FRAMEBUFFER,k.COLOR_ATTACHMENT0,E.get(Z).__webglTexture,Ne,Qt+xi)),k.blitFramebuffer(je,it,Xe,Oe,at,Lt,Xe,Oe,k.DEPTH_BUFFER_BIT,k.NEAREST);Ve.bindFramebuffer(k.READ_FRAMEBUFFER,null),Ve.bindFramebuffer(k.DRAW_FRAMEBUFFER,null)}else if(ee!==0||w.isRenderTargetTexture||E.has(w)){const pn=E.get(w),bn=E.get(Z);Ve.bindFramebuffer(k.READ_FRAMEBUFFER,sr),Ve.bindFramebuffer(k.DRAW_FRAMEBUFFER,Ta);for(let Tn=0;Tn<qe;Tn++)Bt?k.framebufferTextureLayer(k.READ_FRAMEBUFFER,k.COLOR_ATTACHMENT0,pn.__webglTexture,ee,Ze+Tn):k.framebufferTexture2D(k.READ_FRAMEBUFFER,k.COLOR_ATTACHMENT0,k.TEXTURE_2D,pn.__webglTexture,ee),En?k.framebufferTextureLayer(k.DRAW_FRAMEBUFFER,k.COLOR_ATTACHMENT0,bn.__webglTexture,Ne,Qt+Tn):k.framebufferTexture2D(k.DRAW_FRAMEBUFFER,k.COLOR_ATTACHMENT0,k.TEXTURE_2D,bn.__webglTexture,Ne),ee!==0?k.blitFramebuffer(je,it,Xe,Oe,at,Lt,Xe,Oe,k.COLOR_BUFFER_BIT,k.NEAREST):En?k.copyTexSubImage3D(Ot,Ne,at,Lt,Qt+Tn,je,it,Xe,Oe):k.copyTexSubImage2D(Ot,Ne,at,Lt,je,it,Xe,Oe);Ve.bindFramebuffer(k.READ_FRAMEBUFFER,null),Ve.bindFramebuffer(k.DRAW_FRAMEBUFFER,null)}else En?w.isDataTexture||w.isData3DTexture?k.texSubImage3D(Ot,Ne,at,Lt,Qt,Xe,Oe,qe,Ft,$e,jt.data):Z.isCompressedArrayTexture?k.compressedTexSubImage3D(Ot,Ne,at,Lt,Qt,Xe,Oe,qe,Ft,jt.data):k.texSubImage3D(Ot,Ne,at,Lt,Qt,Xe,Oe,qe,Ft,$e,jt):w.isDataTexture?k.texSubImage2D(k.TEXTURE_2D,Ne,at,Lt,Xe,Oe,Ft,$e,jt.data):w.isCompressedTexture?k.compressedTexSubImage2D(k.TEXTURE_2D,Ne,at,Lt,jt.width,jt.height,Ft,jt.data):k.texSubImage2D(k.TEXTURE_2D,Ne,at,Lt,Xe,Oe,Ft,$e,jt);k.pixelStorei(k.UNPACK_ROW_LENGTH,lt),k.pixelStorei(k.UNPACK_IMAGE_HEIGHT,yn),k.pixelStorei(k.UNPACK_SKIP_PIXELS,Xi),k.pixelStorei(k.UNPACK_SKIP_ROWS,Mn),k.pixelStorei(k.UNPACK_SKIP_IMAGES,ai),Ne===0&&Z.generateMipmaps&&k.generateMipmap(Ot),Ve.unbindTexture()},this.initRenderTarget=function(w){E.get(w).__webglFramebuffer===void 0&&W.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?W.setTextureCube(w,0):w.isData3DTexture?W.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?W.setTexture2DArray(w,0):W.setTexture2D(w,0),Ve.unbindTexture()},this.resetState=function(){H=0,J=0,q=null,Ve.reset(),ze.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return zi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Ct._getDrawingBufferColorSpace(t),i.unpackColorSpace=Ct._getUnpackColorSpace()}}const yA=()=>{const s=Be.useRef(null),t=Be.useRef(null),i=Be.useRef(null),r=Be.useRef(new Nt(0,0)),l=Be.useRef(0),c=Be.useRef(!0);return Be.useEffect(()=>{if(c.current=!0,!s.current)return;const d=new Dv,h=new Jc(-1,1,1,-1,0,1),m=new Bv({alpha:!1,antialias:!1,powerPreference:"high-performance",stencil:!1,depth:!1});m.setPixelRatio(1),m.setSize(window.innerWidth,window.innerHeight),s.current.appendChild(m.domElement),t.current=m;const p=`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = vec4(position, 1.0);
  ...
  `;return Be.useEffect(()=>{const de=document.createElement("canvas");de.width=1,de.height=1;const be=de.getContext("2d");be&&(be.fillStyle="rgba(0,0,0,0)",be.fillRect(0,0,1,1));const Q=new m_(de);return H.current=Q,ne.current=window.setInterval(()=>{const ae=performance.now();q.current.forEach((Ae,He)=>{const Ge=ae-Ae.lastFrameTime,ct=Ae.delays[Ae.currentFrame]||100;Ge>=ct&&(Ae.currentFrame=(Ae.currentFrame+1)%Ae.frames.length,Ae.lastFrameTime=ae,Ae.ctx.putImageData(Ae.frames[Ae.currentFrame],0,0),He.needsUpdate=!0)})},16),()=>{ne.current&&clearInterval(ne.current)}},[]),Be.useEffect(()=>{if(!i.current)return;const de=F.current,be=new Dv;r.current=be;const Q=new Jc(B/-2,B/2,G/2,G/-2,1,1e3);Q.position.z=100,l.current=Q;const ae=new Bv({alpha:!0,antialias:!0,powerPreference:"high-performance"});ae.setSize(de.width,de.height),ae.setPixelRatio(Math.min(window.devicePixelRatio,2)),ae.sortObjects=!0,ae.domElement.style.display="block",ae.domElement.style.position="absolute",ae.domElement.style.top="0",ae.domElement.style.left="0",i.current.appendChild(ae.domElement),c.current=ae,t.current&&(t.current.style.width=`${de.width}px`,t.current.style.height=`${de.height}px`);const Ae=new Ko;be.add(Ae),d.current=Ae;const He=(et,k,St,Qe,ut)=>{const Ve=new Gs(et,k),P=new gi({uniforms:{uTexture:{value:null},uTextureOld:{value:null},uHasOld:{value:0},uProgress:{value:0},uSeed:{value:J.current},uResolution:{value:new Nt(et,k)}},transparent:!0,vertexShader:ie,fragmentShader:_e,side:Ii}),E=new wi(Ve,P);return E.position.set(St,Qe,ut),E.visible=!1,Ae.add(E),g.current.push(P),E},Ge=He(483,322,_.current.main.x,_.current.main.y,_.current.main.z);h.current=Ge;const ct=He(253,172,_.current.tl.x,_.current.tl.y,_.current.tl.z);m.current=ct;const Yt=He(207,276,_.current.br.x,_.current.br.y,_.current.br.z);p.current=Yt;const pt=()=>{if(!(v.current>.001||y.current>.001)){b.current=!1,t.current&&(t.current.style.opacity="0");return}T.current=requestAnimationFrame(pt);const k=y.current<v.current,St=y.current-v.current;v.current+=St*(k?.045:.015),Math.abs(y.current-v.current)<.001&&(v.current=y.current),g.current.forEach(we=>{we&&(we.uniforms.uProgress.value=v.current)});const Qe=U.current;N.current.x+=(Qe.x-N.current.x)*.05,N.current.y+=(Qe.y-N.current.y)*.05,D.current.x+=(Qe.x-D.current.x)*.03,D.current.y+=(Qe.y-D.current.y)*.03,O.current.x+=(Qe.x-O.current.x)*.09,O.current.y+=(Qe.y-O.current.y)*.09,L.current.x+=(Qe.x-L.current.x)*.07,L.current.y+=(Qe.y-L.current.y)*.07;const ut=N.current.x,Ve=N.current.y,P=performance.now()/1e3,E=v.current,W=z.current,pe=Math.sin(P*.45+W.main.px)*6*E,ye=Math.sin(P*.37+W.main.py)*5*E,he=Math.sin(P*.28+W.main.pr)*.008*E,ke=Math.sin(P*.52+W.tl.px)*9*E,Re=Math.sin(P*.41+W.tl.py)*7*E,We=Math.sin(P*.33+W.tl.pr)*.012*E,nt=Math.sin(P*.48+W.br.px)*8*E,Ee=Math.sin(P*.35+W.br.py)*6*E,Ce=Math.sin(P*.25+W.br.pr)*.01*E,Ie=.19;if(d.current&&(d.current.rotation.y=ut*Ie,d.current.rotation.x=-Ve*Ie),h.current){const we=_.current.main;h.current.position.x=we.x+D.current.x*22+pe,h.current.position.y=we.y+D.current.y*22+ye,h.current.rotation.z=he}if(m.current){const we=_.current.tl;m.current.position.x=we.x+O.current.x*48+ke,m.current.position.y=we.y+O.current.y*48+Re,m.current.rotation.z=We}if(p.current){const we=_.current.br;p.current.position.x=we.x+L.current.x*36+nt,p.current.position.y=we.y+L.current.y*36+Ee,p.current.rotation.z=Ce}const Pe=x.current-I.current;I.current+=Pe*.12,t.current&&(t.current.style.transform=`translate3d(-50%, ${I.current}px, 0)`,g.current.length>0&&(v.current>.01?(t.current.style.opacity="1",ae.render(be,Q)):t.current.style.opacity="0"))},mt=()=>{b.current||(b.current=!0,pt())};M.current=mt;const st=et=>{const k=et.clientX/window.innerWidth*2-1,St=-(et.clientY/window.innerHeight*2-1);U.current={x:k,y:St}};window.addEventListener("mousemove",st);const Ke=()=>{const et=te();ge(et),ae.setSize(et.width,et.height),t.current&&(t.current.style.width=`${et.width}px`,t.current.style.height=`${et.height}px`)};return window.addEventListener("resize",Ke),()=>{cancelAnimationFrame(T.current),window.removeEventListener("mousemove",st),window.removeEventListener("resize",Ke),i.current&&ae.domElement&&i.current.removeChild(ae.domElement),ae.dispose(),g.current.forEach(et=>et.dispose()),g.current=[],M.current=null,d.current=null}},[te,ge]),Be.useEffect(()=>{var be,Q;const de=Math.random();if($.current=de,s&&s.project.img){const{project:ae,top:Ae,height:He}=s,ct=Ae+He/2-F.current.height/2;x.current=ct,_.current.main.y=0,v.current<.05&&g.current.length>0&&g.current[0].uniforms.uHasOld.value<.5&&(I.current=ct);const Yt=st=>st.toLowerCase().endsWith(".gif"),pt=st=>st?C.current.has(st)?Promise.resolve(C.current.get(st)):Yt(st)?fetch(st).then(Ke=>Ke.arrayBuffer()).then(Ke=>{const et=j_.parseGIF(Ke),k=j_.decompressFrames(et,!0);if(k.length===0)return H.current;const St=et.lsd.width,Qe=et.lsd.height,ut=document.createElement("canvas");ut.width=St,ut.height=Qe;const Ve=ut.getContext("2d");if(!Ve)return H.current;const P=document.createElement("canvas");P.width=St,P.height=Qe;const E=P.getContext("2d"),W=document.createElement("canvas"),pe=W.getContext("2d"),ye=[];k.forEach((Re,We)=>{if(We>0){const Ee=k[We-1];Ee.disposalType===2&&E.clearRect(Ee.dims.left,Ee.dims.top,Ee.dims.width,Ee.dims.height)}W.width=Re.dims.width,W.height=Re.dims.height;const nt=new ImageData(new Uint8ClampedArray(Re.patch),Re.dims.width,Re.dims.height);pe.putImageData(nt,0,0),E.drawImage(W,Re.dims.left,Re.dims.top),ye.push(E.getImageData(0,0,St,Qe))});const he=k.map(Re=>Re.delay||100);Ve.putImageData(ye[0],0,0);const ke=new m_(ut);return ke.wrapS=ti,ke.wrapT=ti,ke.minFilter=dn,ke.magFilter=dn,ke.generateMipmaps=!1,q.current.set(ke,{frames:ye,delays:he,currentFrame:0,lastFrameTime:performance.now(),canvas:ut,ctx:Ve}),C.current.set(st,ke),ke}).catch(()=>H.current):new Promise(Ke=>{A.current.load(st,et=>{et.wrapS=ti,et.wrapT=ti,et.minFilter=dn,et.magFilter=dn,et.center.set(.5,.5),et.repeat.set(1,1),et.needsUpdate=!0,C.current.set(st,et),Ke(et)},void 0,()=>{Ke(H.current)})}):Promise.resolve(H.current),mt=[ae.img,(be=ae.subImages)==null?void 0:be[0],(Q=ae.subImages)==null?void 0:Q[1]];Promise.all(mt.map(pt)).then(st=>{if($.current!==de)return;const Ke=g.current,et=[h.current,m.current,p.current],k=v.current>.15;st.forEach((St,Qe)=>{if(Ke[Qe]&&et[Qe]){const ut=Ke[Qe].uniforms.uTexture.value,Ve=et[Qe].visible,P=ut&&ut!==H.current;Ve&&P&&k?(Ke[Qe].uniforms.uTextureOld.value=ut,Ke[Qe].uniforms.uHasOld.value=1):Ke[Qe].uniforms.uHasOld.value=0,Ke[Qe].uniforms.uTexture.value=St;const E=St!==H.current,W=Ke[Qe].uniforms.uHasOld.value>.5;E||W?et[Qe].visible=!0:et[Qe].visible=!1}}),v.current=0,y.current=1,M.current&&M.current()}),M.current&&M.current()}else y.current=0,g.current.forEach(ae=>{ae.uniforms.uHasOld.value=0}),M.current&&M.current()},[s]),j.jsxs("div",{ref:t,className:"fixed top-0 left-1/2 z-50 pointer-events-none",style:{width:`${ve.width}px`,height:`${ve.height}px`,opacity:0,transform:"translate3d(-50%, -2000px, 0)"},children:[j.jsx("div",{ref:i,className:"absolute inset-0 z-0"}),s&&s.project.description&&j.jsxs("div",{className:"absolute top-1/2 bg-black/80 backdrop-blur-md p-6 border border-white/10 text-white text-xs font-mono uppercase leading-relaxed tracking-wider z-[60] shadow-2xl rounded-sm transition-opacity duration-300",style:{left:"72%",width:"280px",transform:"translateY(-50%) translateZ(20px)",opacity:s?1:0},children:[j.jsx("span",{className:"block mb-3 text-white font-bold text-sm border-b border-white/20 pb-2",children:s.project.name}),j.jsx("p",{className:"text-gray-300 normal-case",children:s.project.description})]})]})},CA="1f18c55d021ac35f6da072db92dafacd",wA="ts6ki",DA="https://ws.audioscrobbler.com/2.0/",UA=3e4,NA="2a96cbd8b46e442fc41c2b86b821562f",LA=s=>{var i,r;const t=((i=s==null?void 0:s.find(l=>l.size==="extralarge"))==null?void 0:i["#text"])||((r=s==null?void 0:s[s.length-1])==null?void 0:r["#text"])||"";return!t||t.includes(NA)?null:t},OA=s=>{var t,i;return{name:s.name,artist:((t=s.artist)==null?void 0:t["#text"])??"",album:((i=s.album)==null?void 0:i["#text"])??"",image:LA(s.image),url:s.url,playedAt:s.date?parseInt(s.date.uts,10):null}};function PA(){const[s,t]=Be.useState({status:"loading",track:null}),i=Be.useRef(null);return Be.useEffect(()=>{let r=!1;const l=`${DA}?method=user.getrecenttracks&user=${wA}&api_key=${CA}&format=json&limit=1`,c=async()=>{var p,_,g,v;(p=i.current)==null||p.abort();const m=new AbortController;i.current=m;try{const y=await fetch(l,{signal:m.signal});if(!y.ok)throw new Error(`Last.fm ${y.status}`);const b=await y.json(),T=(g=(_=b==null?void 0:b.recenttracks)==null?void 0:_.track)==null?void 0:g[0];if(!T){r||t({status:"recent",track:null});return}const M=OA(T),x=((v=T["@attr"])==null?void 0:v.nowplaying)==="true";r||t({status:x?"playing":"recent",track:M})}catch(y){if(y.name==="AbortError")return;r||t(b=>b.track?b:{status:"error",track:null})}};c();const d=window.setInterval(()=>{document.hidden||c()},UA),h=()=>{document.hidden||c()};return document.addEventListener("visibilitychange",h),()=>{var m;r=!0,clearInterval(d),(m=i.current)==null||m.abort(),document.removeEventListener("visibilitychange",h)}},[]),s}const FA=[["top-left","┌"],["top-right","┐"],["bottom-left","└"],["bottom-right","┘"]],tr=({children:s,title:t,rightTag:i,className:r="",contentClassName:l=""})=>j.jsxs("div",{className:`tui-panel ${r}`,role:"region","aria-label":t,children:[FA.map(([c,d])=>j.jsx("span",{"aria-hidden":"true",className:`tui-panel__corner tui-panel__corner--${c}`,children:d},c)),j.jsxs("div",{className:"tui-panel__title","aria-hidden":"true",children:[j.jsx("span",{className:"text-white/40",children:"─["}),j.jsx("span",{className:"text-gray-200",children:t}),j.jsx("span",{className:"text-white/40",children:"]─"})]}),i&&j.jsxs("div",{className:"tui-panel__tag","aria-hidden":"true",children:["[",i,"]"]}),j.jsx("div",{className:`tui-panel__content ${l}`,children:s})]}),IA="https://www.last.fm/user/ts6ki",BA=s=>{const t=Math.max(0,Math.floor(Date.now()/1e3-s));if(t<60)return"just now";const i=Math.floor(t/60);if(i<60)return`${i}m ago`;const r=Math.floor(i/60);return r<24?`${r}h ago`:`${Math.floor(r/24)}d ago`},zA=()=>j.jsxs("span",{className:"np-eq","aria-hidden":"true",children:[j.jsx("span",{className:"np-bar"}),j.jsx("span",{className:"np-bar"}),j.jsx("span",{className:"np-bar"})]}),HA=()=>{const{status:s,track:t}=PA();if(s==="error")return null;const i=s==="playing";return j.jsx(tr,{title:"~/now-playing",children:j.jsxs("a",{href:IA,target:"_blank",rel:"noopener noreferrer",title:"Last.fm - ts6ki",className:"group block",children:[j.jsxs("div",{className:"mb-3 flex items-center justify-between gap-3 font-pixel text-[9px] uppercase tracking-[0.14em] text-gray-500",children:[j.jsxs("span",{className:"flex items-center gap-2 transition-colors group-hover:text-white",children:[i?j.jsx(zA,{}):j.jsx("span",{className:"h-1.5 w-1.5 bg-gray-500 group-hover:bg-white"}),"now-playing:"]}),j.jsx("span",{className:"shrink-0 transition-colors group-hover:text-white",children:"last.fm ↗"})]}),j.jsxs("div",{className:"grid grid-cols-[2.5rem_minmax(0,1fr)] items-center gap-3",children:[j.jsx("div",{className:"h-10 w-10 overflow-hidden border border-white/15 bg-white/[0.03] transition-colors group-hover:border-white/40",children:(t==null?void 0:t.image)&&j.jsx("img",{src:t.image,alt:"",width:40,height:40,loading:"lazy",className:"h-full w-full object-cover"})}),j.jsx("div",{className:"min-w-0 truncate text-xs text-gray-300 transition-all group-hover:text-white group-hover:[text-shadow:0_0_8px_rgba(255,255,255,0.45)]",children:s==="loading"?j.jsx("span",{className:"text-gray-500",children:"reading recenttracks ..."}):t?j.jsxs(j.Fragment,{children:[t.name," ",j.jsx("span",{className:"text-gray-600",children:"--"})," ",t.artist,!i&&t.playedAt&&j.jsxs("span",{className:"text-gray-600",children:[" / ",BA(t.playedAt)]})]}):j.jsx("span",{className:"text-gray-500",children:"nothing scrobbled yet"})})]})]})})},Ns=({command:s,user:t="shivam",host:i="scu",path:r="~",cursor:l=!0,className:c=""})=>j.jsxs("div",{className:`tui-prompt ${c}`,children:[j.jsxs("span",{className:"text-gray-400",children:[t,"@",i]}),j.jsxs("span",{className:"text-gray-600",children:[":",r,"$"]}),j.jsx("span",{className:"text-gray-200",children:s}),l&&j.jsx("span",{className:"blink-cursor text-white","aria-hidden":"true",children:"▮"})]}),Z_="https://letterboxd.com/shiv8m/",GA="/",K_=[{title:"2001: A Space Odyssey",year:1968,file:"2001-a-space-odyssey.jpg"},{title:"Blade Runner",year:1982,file:"blade-runner.jpg"},{title:"Vampire Hunter D: Bloodlust",year:2e3,file:"vampire-hunter-d.jpg"},{title:"Whiplash",year:2014,file:"whiplash.jpg"}],VA=()=>j.jsxs(tr,{title:"~/favorite-films",rightTag:String(K_.length),children:[j.jsxs("a",{href:Z_,target:"_blank",rel:"noopener noreferrer",className:"group mb-5 flex items-center justify-between gap-3",children:[j.jsx(Ns,{command:"ls ./favorites --posters",cursor:!1}),j.jsx("span",{className:"hidden shrink-0 font-pixel text-[9px] uppercase tracking-[0.14em] text-gray-500 transition-colors group-hover:text-white sm:block",children:"letterboxd ↗"})]}),j.jsx("div",{className:"grid grid-cols-4 gap-1.5 sm:gap-2.5",children:K_.map(s=>j.jsxs("a",{href:Z_,target:"_blank",rel:"noopener noreferrer",title:`${s.title} (${s.year})`,className:"group block min-w-0",children:[j.jsx("img",{src:`${GA}images/films/${s.file}`,alt:s.title,width:200,height:300,loading:"lazy",className:"aspect-[2/3] w-full border border-white/15 object-cover transition-all duration-300 group-hover:border-white/40 group-hover:brightness-110 group-hover:[box-shadow:0_0_12px_rgba(255,255,255,0.25)] motion-safe:group-hover:-translate-y-1"}),j.jsxs("span",{className:"mt-2 hidden truncate font-pixel text-[8px] uppercase tracking-[0.08em] text-gray-600 transition-colors group-hover:text-gray-300 sm:block",children:[s.year," / ",s.title]})]},s.file))})]}),kA=String.raw`
███████╗██╗  ██╗██╗██╗   ██╗ █████╗ ███╗   ███╗    ███╗   ███╗ █████╗      ██╗██╗
██╔════╝██║  ██║██║██║   ██║██╔══██╗████╗ ████║    ████╗ ████║██╔══██╗     ██║██║
███████╗███████║██║██║   ██║███████║██╔████╔██║    ██╔████╔██║███████║     ██║██║
╚════██║██╔══██║██║╚██╗ ██╔╝██╔══██║██║╚██╔╝██║    ██║╚██╔╝██║██╔══██║██   ██║██║
███████║██║  ██║██║ ╚████╔╝ ██║  ██║██║ ╚═╝ ██║    ██║ ╚═╝ ██║██║  ██║╚█████╔╝██║
╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝  ╚═╝  ╚═╝╚═╝     ╚═╝    ╚═╝     ╚═╝╚═╝  ╚═╝ ╚════╝ ╚═╝`,XA=({className:s="",ariaHidden:t=!1})=>j.jsx("pre",{"aria-label":t?void 0:"Shivam Maji","aria-hidden":t||void 0,className:`ascii-banner ${s}`,children:kA}),Q_=({children:s,className:t="",position:i="bottom"})=>j.jsx("div",{className:`tui-status-bar tui-status-bar--${i} ${t}`,children:s}),Gc=()=>j.jsx("span",{"aria-hidden":"true",children:"↗"}),qd=({label:s,children:t})=>j.jsxs("div",{className:"grid grid-cols-[3.25rem_1fr] gap-2",children:[j.jsxs("span",{className:"text-white",children:["[ ",s," ]"]}),j.jsx("span",{className:"text-gray-500",children:t})]}),WA=()=>{const[s,t]=Be.useState(null),[i,r]=Be.useState(null),[l,c]=Be.useState([]),[d,h]=Be.useState(0),[m,p]=Be.useState(null),[_,g]=Be.useState(""),v=Be.useRef(null),y=Be.useRef(null),b=Be.useRef(0),T=Be.useRef(0),M=Be.useRef(0);Be.useEffect(()=>{fetch("/data/projects.json").then(D=>D.json()).then(D=>c(D)).catch(D=>console.error("Failed to load projects",D))},[]),Be.useEffect(()=>{const D="shivam-majis-team-2734",O="first-counter-2734",L="https://api.allorigins.win/raw?url=",z="portfolio_counted_this_session",A="portfolio_last_count",C=sessionStorage.getItem(z);(async()=>{var q,ne;const J=localStorage.getItem(A);J&&h(parseInt(J,10));try{const $=new AbortController,B=setTimeout(()=>$.abort(),5e3),te=`https://api.counterapi.dev/v2/${D}/${O}/${C?"get":"up"}`,ve=await fetch(`${L}${encodeURIComponent(te)}`,{signal:$.signal});if(clearTimeout(B),!ve.ok)throw new Error("API error");const ge=await ve.json(),F=((q=ge.data)==null?void 0:q.up_count)??((ne=ge.data)==null?void 0:ne.count);F&&(h(F),localStorage.setItem(A,F.toString()),sessionStorage.setItem(z,"true"))}catch{if(!J){const $=localStorage.getItem("portfolio_visitor_fallback"),B=($?parseInt($,10):14203)+(C?0:1);localStorage.setItem("portfolio_visitor_fallback",B.toString()),h(B)}}})()},[]),Be.useEffect(()=>{(async()=>{try{const L=await(await fetch("https://api.open-meteo.com/v1/forecast?latitude=37.3486&longitude=-121.9367&current_weather=true")).json();p(Math.round(L.current_weather.temperature))}catch(O){console.error("Weather fetch failed",O)}})()},[]),Be.useEffect(()=>{const D=()=>{g(new Intl.DateTimeFormat("en-US",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(new Date))};D();const O=window.setInterval(D,1e3);return()=>window.clearInterval(O)},[]),Be.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const D=()=>{b.current=window.scrollY},O=()=>{var L;if(v.current){const z=b.current*.35;T.current+=(z-T.current)*.08;const A=((L=y.current)==null?void 0:L.getBoundingClientRect().width)??0,C=A>0?T.current%A:T.current;v.current.style.transform=`translateX(-${C}px)`}M.current=requestAnimationFrame(O)};return window.addEventListener("scroll",D,{passive:!0}),M.current=requestAnimationFrame(O),()=>{window.removeEventListener("scroll",D),cancelAnimationFrame(M.current)}},[]);const x=D=>{const O=D%100;return O>=11&&O<=13?"th":D%10===1?"st":D%10===2?"nd":D%10===3?"rd":"th"},I=D=>{var O;(O=document.getElementById(D))==null||O.scrollIntoView({behavior:"smooth"})},U=()=>i!==null?"opacity-20 blur-[2px]":"opacity-100",N=({label:D,target:O})=>j.jsxs("button",{onClick:()=>I(O),className:"text-gray-400 transition-all hover:text-white hover:[text-shadow:0_0_8px_rgba(255,255,255,0.6)]",children:["[",D,"]"]});return j.jsxs(j.Fragment,{children:[j.jsx(RA,{previewState:s}),j.jsxs("div",{className:"relative z-10 w-full cursor-none font-mono text-[#f0f0f0] selection:bg-white selection:text-black",children:[j.jsx("nav",{className:`fixed inset-x-0 top-0 z-50 mix-blend-difference transition-all duration-500 ${U()}`,children:j.jsxs(Q_,{position:"top",className:"h-9 justify-between px-3 md:px-6",children:[j.jsxs("div",{className:"flex min-w-0 items-center gap-2 md:gap-3",children:[j.jsx("span",{className:"shrink-0 bg-white px-2 py-1 text-black",children:"NORMAL"}),j.jsx("span",{className:"hidden sm:inline",children:"shivam-os 1.0"}),j.jsx("span",{className:"tui-status-separator hidden sm:inline",children:"│"}),j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx(N,{label:"prj",target:"projects"}),j.jsx(N,{label:"who",target:"about"}),j.jsx(N,{label:"msg",target:"contact"})]})]}),j.jsxs("div",{className:"flex shrink-0 items-center gap-2 md:gap-3",children:[j.jsx("span",{className:"hidden md:inline",children:"tty1"}),j.jsx("span",{className:"tui-status-separator hidden md:inline",children:"│"}),j.jsx("time",{children:_||"--:--:--"})]})]})}),j.jsxs("header",{className:`w-full overflow-hidden pb-20 pt-24 transition-all duration-500 md:pb-28 md:pt-32 ${U()}`,children:[j.jsx("div",{className:"px-4 md:px-12",children:j.jsxs("div",{className:"mb-8 font-pixel text-[9px] uppercase leading-5 tracking-[0.12em] md:text-[10px]",children:[j.jsx(qd,{label:"ok",children:"mounted /dev/portfolio"}),j.jsx(qd,{label:"ok",children:"loaded tui.session"}),j.jsx(qd,{label:"ok",children:"network online"})]})}),j.jsx("div",{ref:v,className:"flex w-max will-change-transform",style:{transform:"translateX(0px)"},children:Array.from({length:5},(D,O)=>j.jsx("div",{ref:O===0?y:void 0,className:"shrink-0",children:j.jsx(XA,{className:"px-4 md:px-12",ariaHidden:O>0})},O))}),j.jsxs("div",{className:"mt-10 max-w-2xl px-4 md:mt-14 md:px-12",children:[j.jsx(Ns,{command:"whoami",className:"mb-5"}),j.jsxs("div",{className:"tui-command-output",children:[j.jsxs("p",{className:"text-sm font-medium leading-relaxed text-gray-300 md:text-base",children:["Shivam Maji, a ",j.jsx("span",{className:"text-white",children:"Computer Engineering"})," and"," ",j.jsx("span",{className:"text-white",children:"Mechanical Engineering"})," student at SCU."]}),j.jsxs("div",{className:"mt-5 flex items-center gap-3 font-pixel text-[9px] uppercase tracking-[0.14em] text-gray-500 md:text-[10px]",children:[j.jsx("span",{className:"h-2 w-2 animate-pulse bg-white shadow-[0_0_8px_white]"}),j.jsxs("span",{children:["session #",d.toLocaleString(),x(d)," visitor"]})]})]})]})]}),j.jsxs("main",{className:"space-y-24 px-4 pb-24 md:space-y-32 md:px-12 md:pb-32",children:[j.jsx("section",{id:"projects",className:"scroll-mt-16",children:j.jsxs(tr,{title:"~/selected-projects",rightTag:l.length?String(l.length):"...",contentClassName:"!p-0",children:[j.jsxs("div",{className:"border-b border-white/10 px-3 py-3 font-pixel text-[8px] uppercase tracking-[0.14em] text-gray-600 md:grid md:grid-cols-[4rem_8rem_1fr_12rem_4rem] md:px-5 md:text-[9px]",children:[j.jsx("span",{children:"mode"}),j.jsx("span",{className:"hidden md:block",children:"type"}),j.jsx("span",{className:"hidden md:block",children:"name"}),j.jsx("span",{className:"hidden md:block",children:"tags"}),j.jsx("span",{className:"hidden md:block text-right",children:"link"})]}),l.length===0&&j.jsx("div",{className:"px-4 py-8 font-pixel text-[10px] uppercase tracking-widest text-gray-500 animate-pulse",children:"reading ./data/projects.json ..."}),l.map((D,O)=>{var A;const L=i===O,z=i!==null&&!L;return j.jsxs("a",{href:D.url,target:"_blank",rel:"noopener noreferrer",onMouseEnter:C=>{const H=C.currentTarget.getBoundingClientRect();t({project:D,top:H.top,height:H.height}),r(O)},onMouseLeave:()=>{t(null),r(null)},className:`group grid min-w-0 grid-cols-[3rem_minmax(0,1fr)_2rem] items-center gap-2 border-b border-white/10 px-3 py-5 transition-all duration-500 last:border-b-0 md:grid-cols-[4rem_8rem_minmax(0,1fr)_12rem_4rem] md:px-5 ${L?"border-white/50 bg-white/[0.04] text-white":""} ${z?"opacity-20 blur-[1px]":""}`,children:[j.jsxs("span",{className:"font-pixel text-[9px] text-gray-500 transition-colors group-hover:text-white md:text-[10px]",children:["-rwx/",D.year]}),j.jsx("span",{className:"hidden truncate font-pixel text-[9px] uppercase text-gray-500 md:block",children:D.type}),j.jsx("span",{className:"min-w-0 truncate text-sm uppercase tracking-tight text-gray-200 transition-all group-hover:translate-x-1 group-hover:text-white group-hover:[text-shadow:0_0_10px_rgba(255,255,255,0.4)] md:text-lg",children:D.name}),j.jsx("span",{className:"hidden truncate font-pixel text-[9px] uppercase text-gray-500 md:block",children:(A=D.field)==null?void 0:A.map(C=>`(${C.toLowerCase()})`).join(" ")}),j.jsxs("span",{className:"text-right font-pixel text-[11px] text-gray-500 transition-colors group-hover:text-white",children:["[",j.jsx(Gc,{}),"]"]})]},`${D.year}-${D.name}`)})]})}),j.jsxs("section",{className:`grid grid-cols-1 gap-10 transition-all duration-500 lg:grid-cols-12 lg:gap-8 ${U()}`,children:[j.jsxs("div",{className:"space-y-10 lg:col-span-5",children:[j.jsxs(tr,{title:"~/achievements",rightTag:String(H_.length),children:[j.jsx(Ns,{command:"ls -la ./achievements",cursor:!1,className:"mb-5"}),j.jsx("ul",{className:"space-y-3",children:H_.map(D=>j.jsxs("li",{className:"grid grid-cols-[3.5rem_1fr] gap-3 text-sm text-gray-300 transition-colors hover:text-white",children:[j.jsx("span",{className:"font-pixel text-gray-500",children:D.count}),j.jsx("span",{children:D.name})]},D.name))})]}),j.jsxs(tr,{title:"~/special-thanks",rightTag:String(G_.length),children:[j.jsx(Ns,{command:"cat CREDITS",cursor:!1,className:"mb-5"}),j.jsx("ul",{className:"space-y-3",children:G_.map(D=>{const O=typeof D=="string"?D:D.name;return j.jsxs("li",{className:"flex gap-3 text-sm text-gray-300 transition-colors hover:text-white",children:[j.jsx("span",{className:"text-gray-600",children:"*"}),typeof D=="string"?j.jsx("span",{children:D}):j.jsxs("a",{href:D.url,target:"_blank",rel:"noopener noreferrer",className:"hover:underline",children:[D.name," ",j.jsx(Gc,{})]})]},O)})})]}),j.jsx("div",{id:"contact",className:"scroll-mt-16",children:j.jsxs(tr,{title:"~/contact",children:[j.jsx(Ns,{command:"cat contact.txt",cursor:!1,className:"mb-5"}),j.jsxs("div",{className:"tui-command-output",children:[j.jsx("p",{className:"mb-7 text-sm leading-relaxed text-gray-300",children:"Here are several ways you can slide into my DMs. I am currently working as a freelancer and open for collaborations, long and short term."}),j.jsxs("ul",{className:"space-y-3",children:[Xd.socials.map(D=>j.jsx("li",{children:j.jsxs("a",{href:D.url,target:"_blank",rel:"noopener noreferrer",className:"group flex items-center gap-3",children:[j.jsx("span",{className:"text-gray-600 group-hover:text-white",children:"->"}),j.jsxs("span",{className:"font-pixel text-[10px] uppercase tracking-widest text-gray-400 transition-all group-hover:text-white group-hover:[text-shadow:0_0_8px_rgba(255,255,255,0.55)]",children:[D.name," ",j.jsx(Gc,{})]})]})},D.name)),j.jsx("li",{children:j.jsxs("a",{href:`mailto:${Xd.email}`,className:"group flex items-center gap-3",children:[j.jsx("span",{className:"text-gray-600 group-hover:text-white",children:"->"}),j.jsxs("span",{className:"font-pixel text-[10px] uppercase tracking-widest text-gray-400 transition-all group-hover:text-white group-hover:[text-shadow:0_0_8px_rgba(255,255,255,0.55)]",children:["mail: ",Xd.email]})]})})]})]})]})}),j.jsx(HA,{}),kd.length>0&&j.jsx(tr,{title:"~/publications",rightTag:String(kd.length),children:j.jsx("ul",{className:"space-y-3",children:kd.map(D=>j.jsx("li",{children:j.jsxs("a",{href:D.url,target:"_blank",rel:"noopener noreferrer",className:"group flex gap-3 text-sm text-gray-300 hover:text-white",children:[j.jsx(Gc,{}),j.jsx("span",{className:"group-hover:underline",children:D.name})]})},D.name))})})]}),j.jsxs("div",{className:"space-y-10 self-start lg:col-start-7 lg:col-span-6",children:[j.jsxs(tr,{title:"cat ~/about.txt",className:"scroll-mt-16",contentClassName:"space-y-7",children:[j.jsx("div",{id:"about",className:"scroll-mt-16",children:j.jsx(Ns,{command:"cat about.txt",cursor:!1})}),j.jsx("div",{className:"tui-command-output space-y-6 text-base font-light leading-relaxed text-gray-300 md:text-xl",children:MA.map(D=>j.jsx("p",{className:"transition-colors duration-300 hover:text-white",children:D},D))})]}),j.jsx(VA,{})]})]})]}),j.jsx("footer",{className:`transition-all duration-500 ${U()}`,children:j.jsxs(Q_,{className:"min-h-9 flex-wrap justify-between px-3 py-2 md:px-6",children:[j.jsxs("div",{className:"flex items-center gap-2 md:gap-3",children:[j.jsx("span",{className:"bg-white px-2 py-1 text-black",children:"portfolio"}),j.jsx("span",{className:"hidden sm:inline",children:"37.3486°n/121.9367°w"}),j.jsx("span",{className:"tui-status-separator hidden sm:inline",children:"│"}),j.jsx("span",{children:m!==null?`${m}°c`:"--°c"})]}),j.jsxs("div",{className:"flex items-center gap-2 md:gap-3",children:[j.jsxs("span",{className:"flex items-center gap-2 text-gray-300",children:[j.jsx("span",{className:"h-1.5 w-1.5 animate-pulse bg-white shadow-[0_0_5px_white]"}),"online"]}),j.jsx("span",{className:"tui-status-separator",children:"│"}),j.jsx("span",{children:"utf-8"}),j.jsx("span",{className:"tui-status-separator hidden sm:inline",children:"│"}),j.jsx("span",{className:"hidden sm:inline",children:"100%"})]})]})})]})]})},va="$@B%8&WM#*oahkbdpqwmZO0QLCJUYXzcvunxrjft/\\|()1{}[]?-_+~<>i!lI;:,\"^`'. ",tp=(s,t,i)=>Math.max(t,Math.min(i,s));function al(s){const t=tp(s,0,1),i=Math.round((1-t)*(va.length-1));return va[i]}function qA(s,t,i){const r=va.indexOf(s),l=va.indexOf(t);if(r===-1||l===-1)return i<.5?s:t;const c=Math.round(r+(l-r)*tp(i,0,1));return va[c]}function YA(s,t){const i=va.indexOf(s);if(i===-1)return s;const r=Math.round((Math.random()-.5)*2*t);return va[tp(i+r,0,va.length-1)]}const jA=" ",Yo=(s,t,i)=>Math.max(t,Math.min(i,s)),J_=(s,t,i)=>s+(t-s)*i,ZA=s=>s<.5?4*s*s*s:1-Math.pow(-2*s+2,3)/2,KA=s=>s*s,QA=s=>1-Math.pow(1-s,3);let JA=0;function $A({element:s}){let t=0,i=0,r=8,l=15;function c(){const U=getComputedStyle(s),N=document.createElement("span");N.textContent="0".repeat(20),Object.assign(N.style,{position:"absolute",visibility:"hidden",whiteSpace:"pre",font:U.font,fontFamily:U.fontFamily,fontSize:U.fontSize,fontWeight:U.fontWeight,letterSpacing:U.letterSpacing}),document.body.append(N),r=N.getBoundingClientRect().width/N.textContent.length,N.remove(),l=Number.parseFloat(U.lineHeight)||12,t=Math.max(1,Math.floor(window.innerWidth/r)),i=Math.max(1,Math.ceil(window.innerHeight/l))}const d=()=>({cols:t,rows:i,charWidth:r,lineHeight:l});function h(U,N){return{x:Yo(U/(t*r),0,1),y:Yo(N/(i*l),0,1)}}function m({x:U,y:N,value:D,context:O=""}){return{uid:JA++,x:U,y:N,homeX:U,homeY:N,vx:0,vy:0,value:D,context:O,morph:null}}function p({text:U,col:N=0,row:D=0,align:O="left",context:L=""}){const z=U.toUpperCase(),A=O==="center"?Math.floor((t-z.length)/2):N,C=[];for(let H=0;H<z.length;H+=1){const J=z[H];J.trim()&&C.push(m({x:(A+H)/t,y:D/i,value:J,context:L}))}return C}function _(){const U=document.createElement("canvas");return U.width=t,U.height=i,U}function g(U,{context:N="canvas",threshold:D=.08,gamma:O=1,luma:L="rec709",solidGlyph:z=null,solidAbove:A=.62}={}){const C=U.getContext("2d",{willReadFrequently:!0}).getImageData(0,0,U.width,U.height).data,H=L==="max"?(q,ne,$)=>Math.max(q,ne,$):L==="average"?(q,ne,$)=>(q+ne+$)/3:(q,ne,$)=>.2126*q+.7152*ne+.0722*$,J=[];for(let q=0;q<U.height;q+=1)for(let ne=0;ne<U.width;ne+=1){const $=(q*U.width+ne)*4,B=C[$+3]/255;let G=H(C[$],C[$+1],C[$+2])/255*B;if(O!==1&&(G=Math.pow(G,O)),G<D)continue;const te=z&&G>A?z:al(G);J.push(m({x:ne/t,y:q/i,value:te,context:N}))}return J}function v(U,N,D,O){const z=Math.min(1,320/Math.max(N,D)),A=Math.max(1,Math.round(N*z)),C=Math.max(1,Math.round(D*z)),H=document.createElement("canvas");H.width=A,H.height=C;const J=H.getContext("2d",{willReadFrequently:!0});J.drawImage(U,0,0,A,C);const q=J.getImageData(0,0,A,C).data;let ne=A,$=C,B=-1,G=-1;for(let ve=0;ve<C;ve+=1)for(let ge=0;ge<A;ge+=1){const F=(ve*A+ge)*4;Math.max(q[F],q[F+1],q[F+2])/255*(q[F+3]/255)>O&&(ge<ne&&(ne=ge),ge>B&&(B=ge),ve<$&&($=ve),ve>G&&(G=ve))}if(B<0)return null;const te=2;return ne=Math.max(0,ne-te),$=Math.max(0,$-te),B=Math.min(A-1,B+te),G=Math.min(C-1,G+te),{sx:ne/z,sy:$/z,sw:(B-ne+1)/z,sh:(G-$+1)/z}}function y(U,N,{fit:D="contain",scale:O=1,trim:L=!1,trimThreshold:z=.12,invert:A=!1}={}){const C=U.getContext("2d",{willReadFrequently:!0}),H=N.videoWidth||N.naturalWidth||N.width,J=N.videoHeight||N.naturalHeight||N.height;if(!H||!J)return;let q=0,ne=0,$=H,B=J;if(L){const _e=v(N,H,J,z);_e&&({sx:q,sy:ne,sw:$,sh:B}=_e)}C.imageSmoothingEnabled=!0,C.fillStyle="#000",C.fillRect(0,0,U.width,U.height);const G=U.width*r,te=U.height*l,ve=[G/$,te/B],ge=(D==="cover"?Math.max(...ve):Math.min(...ve))*O,F=$*ge/r,ie=B*ge/l;C.drawImage(N,q,ne,$,B,(U.width-F)/2,(U.height-ie)/2,F,ie),A&&(C.globalCompositeOperation="difference",C.fillStyle="#fff",C.fillRect(0,0,U.width,U.height),C.globalCompositeOperation="source-over")}function b(U,N,{duration:D=1700,ease:O="inOut",match:L="scan"}={}){const z=performance.now(),A=O==="in"?KA:O==="out"?QA:ZA;if(!N.length)return[];U.length||(U=[m({x:.5,y:.5,value:" "})]);const C=U.slice(),H=N.slice();for(;C.length<H.length;){const q=U[Math.floor(Math.random()*U.length)];C.push(m({x:q.x,y:q.y,value:q.value,context:q.context}))}const J=L==="radial"?q=>Math.atan2(q.y-.5,q.x-.5):q=>q.y*1e3+q.x;C.sort((q,ne)=>J(q)-J(ne)),H.sort((q,ne)=>J(q)-J(ne));for(let q=0;q<C.length;q+=1){const ne=C[q],$=H[q%H.length],B=q>=H.length;ne.morph={sx:ne.x,sy:ne.y,sval:ne.value,tx:$.x,ty:$.y,tval:$.value,context:$.context,start:z,duration:D,easeFn:A,removeAfter:B}}return C}function T(U,N=performance.now()){const D=[];let O=0;for(const L of U){const z=L.morph;if(!z){D.push(L);continue}const A=Yo((N-z.start)/z.duration,0,1),C=z.easeFn(A);if(L.x=J_(z.sx,z.tx,C),L.y=J_(z.sy,z.ty,C),A>=1){if(z.removeAfter)continue;L.x=z.tx,L.y=z.ty,L.homeX=z.tx,L.homeY=z.ty,L.value=z.tval,L.context=z.context,L.morph=null}else L.value=qA(z.sval,z.tval,C),O+=1;D.push(L)}return{points:D,active:O}}function M(U,N,{spring:D=.4,friction:O=.7}={}){const L=Yo(N*60,0,2);for(const z of U)z.vx+=(z.homeX-z.x)*D,z.vy+=(z.homeY-z.y)*D,z.vx*=O,z.vy*=O,z.x+=z.vx*L,z.y+=z.vy*L}function x(U,N,{gravity:D=1.6,drift:O=0}={}){const L=Yo(N*60,0,2);for(const z of U)z.vy+=D*N,z.vx+=O*N,z.x+=z.vx*L,z.y+=z.vy*L}function I(...U){const N=new Array(t*i).fill(jA);for(const O of U)if(O)for(const L of O){const z=Math.round(L.x*t),A=Math.round(L.y*i);z>=0&&z<t&&A>=0&&A<i&&(N[A*t+z]=L.value)}let D="";for(let O=0;O<i;O+=1)D+=N.slice(O*t,(O+1)*t).join("")+`
`;s.textContent=D}return{measure:c,dimensions:d,pixelToNormalized:h,createPoint:m,createText:p,createCanvas:_,createFromCanvas:g,paintCanvas:y,morph:b,applyMorph:T,applyPhysics:M,applyFall:x,render:I,get cols(){return t},get rows(){return i},ramp:va}}const rl=(s,t,i)=>Math.max(t,Math.min(i,s)),Jo=(s,t,i)=>s+(t-s)*i,Gv=s=>1-Math.pow(1-rl(s,0,1),3);function Gh(s,t){const i=Math.sin(s*127.1+t*311.7)*43758.5453;return i-Math.floor(i)}function eR(s,{elapsed:t,mouseX:i=.5,startupReveal:r=2200,loopDuration:l=9e3}){const{cols:c,rows:d}=s,h=[];if(t<120)return h;const p=Math.max(0,t-r)%l/l,_=Gv(t/r),g=t<r,v=g?_:Math.pow(Math.sin(p*Math.PI),.42);if(v<.035)return h;const y=Jo(-.08,1.08,_),b=.5+(i-.5)*.08,T=(Math.sin(p*Math.PI*2-Math.PI/2)+1)*.5;for(let M=2;M<d-2;M+=1){const x=M/d;if(g&&x>y)continue;const I=Math.abs(x-y),U=Math.sin(x*13+p*Math.PI*4)*.025+Math.sin(x*31-p*Math.PI*3)*.012,N=Jo(.018,.2,T)*v,D=Math.pow(Math.abs(x-.5)*2,1.7),O=g?rl(I/.15,.08,1):1,L=Jo(N*.08,N,D)*O,z=b+U,A=Math.floor((z-L)*c),C=Math.ceil((z+L)*c);for(let H=A;H<=C;H+=1){if(H<0||H>=c)continue;const J=Math.abs(H/c-z)/Math.max(1e-4,L),q=(Math.cos(J*9+p*Math.PI*12+M*.22)+1)*.5;if(q>.3){const ne=1-(J*.65+q*.2);h.push(s.createPoint({x:H/c,y:x,value:al(ne),context:"ribbon"}))}}}return h}function tR(s,{source:t,click:i,elapsed:r,duration:l=1550}){const{cols:c,rows:d}=s,h=d*s.dimensions().lineHeight/(c*s.dimensions().charWidth||1),m=rl(r/l,0,1),p=Jo(0,.85,Gv(m)),_=Jo(.01,.05,m),g=Math.sin(m*Math.PI)*.12,v=t.map(b=>{const T=b.homeX-i.x,M=(b.homeY-i.y)*h,x=Math.hypot(T,M)||1e-4,I=Math.exp(-Math.pow((x-p)/_,2)),U=Math.sin(x*28-m*18)*(1-m)*.006,N=I*g+U;return s.createPoint({x:b.homeX+T/x*N,y:b.homeY+M/x*N*.55,value:YA(b.value,Math.round(I*8)),context:"ripple"})}),y=Math.max(24,Math.floor(p*c));for(let b=0;b<3;b+=1){const T=p-b*_*1.8;if(!(T<=.01))for(let M=0;M<y;M+=1){const x=M/y*Math.PI*2,I=Math.sin(M*4.17+b)*.004;v.push(s.createPoint({x:i.x+Math.cos(x)*(T+I),y:i.y+Math.sin(x)*(T+I)/h,value:s.ramp[12+(M+b*3)%8],context:"ripple-ring"}))}}return v}const nR=[{x:.3,y:.32,rx:.28,ry:.2},{x:.68,y:.3,rx:.25,ry:.18},{x:.48,y:.58,rx:.36,ry:.23},{x:.22,y:.72,rx:.19,ry:.15},{x:.77,y:.7,rx:.2,ry:.17}];function iR(s){const{cols:t,rows:i}=s,r=[];for(let l=1;l<i-1;l+=1)for(let c=1;c<t-1;c+=1){const d=c/t,h=l/i;let m=0;for(const _ of nR){const g=(d-_.x)/_.rx,v=(h-_.y)/_.ry;m=Math.max(m,Math.exp(-(g*g+v*v)*2.2))}const p=Gh(c,l);m>.15&&p<m*.82&&r.push(s.createPoint({x:d,y:h,value:al(m*.8-p*.15),context:"cloud"}))}return r}const aR=s=>s==="max"?(t,i,r)=>Math.max(t,i,r):s==="average"?(t,i,r)=>(t+i+r)/3:(t,i,r)=>.2126*t+.7152*i+.0722*r;function $_(s){return new Promise((t,i)=>{const r=new Image;r.crossOrigin="anonymous",r.onload=()=>t(r),r.onerror=()=>i(new Error(`Failed to load image: ${s}`)),r.src=s})}function rR(s,t,{context:i="art",threshold:r=.12,gamma:l=.85,luma:c="rec709",scale:d=.92,fit:h="contain",trim:m=!1,trimThreshold:p=.12,solidGlyph:_=null,solidAbove:g=.62}={}){const v=s.createCanvas();return s.paintCanvas(v,t,{fit:h,scale:d,trim:m,trimThreshold:p}),s.createFromCanvas(v,{context:i,threshold:r,gamma:l,luma:c,solidGlyph:_,solidAbove:g})}function sR(s,t,{context:i="art",fit:r="contain",scale:l=.9,trim:c=!1,luma:d="max",gamma:h=1,bgThreshold:m=.22,fillFloor:p=.16,fillDensity:_=.4,fillJitter:g=.08}={}){const v=s.createCanvas();s.paintCanvas(v,t,{fit:r,scale:l,trim:c});const y=v.width,b=v.height,T=v.getContext("2d",{willReadFrequently:!0}).getImageData(0,0,y,b).data,M=aR(d),x=new Float32Array(y*b);for(let O=0;O<y*b;O+=1){const L=O*4;let z=M(T[L],T[L+1],T[L+2])/255*(T[L+3]/255);h!==1&&(z=Math.pow(z,h)),x[O]=z}const I=new Uint8Array(y*b),U=[],N=(O,L)=>{if(O<0||L<0||O>=y||L>=b)return;const z=L*y+O;I[z]||x[z]>=m||(I[z]=1,U.push(z))};for(let O=0;O<y;O+=1)N(O,0),N(O,b-1);for(let O=0;O<b;O+=1)N(0,O),N(y-1,O);for(;U.length;){const O=U.pop(),L=O%y,z=O/y|0;N(L-1,z),N(L+1,z),N(L,z-1),N(L,z+1)}const D=[];for(let O=0;O<b;O+=1)for(let L=0;L<y;L+=1){const z=O*y+L;if(I[z])continue;const A=x[z];let C;if(A>=m)C=al(A);else{if(Gh(L,O)>_)continue;const H=(Gh(L*1.7,O*2.3)-.5)*2*g;C=al(p+H)}D.push(s.createPoint({x:L/s.cols,y:O/s.rows,value:C,context:i}))}return D}function oR(s,t="SHIVAM"){const{cols:i,rows:r}=s,l=s.createCanvas(),c=l.getContext("2d",{willReadFrequently:!0}),d=i*.86;let h=Math.floor(r*.5);const m=p=>{c.font=`900 ${p}px "Arial Black", Arial, sans-serif`};for(c.textAlign="center",c.textBaseline="middle",m(h);c.measureText(t).width>d&&h>4;)h-=1,m(h);return c.fillStyle="#000",c.fillRect(0,0,i,r),c.fillStyle="#fff",c.fillText(t,i/2,r/2,d),s.createFromCanvas(l,{context:"name",threshold:.16,solidGlyph:">",solidAbove:.7})}const lR=30,ev=2200,cR=1550,uR="/cat.jpg",fR={luma:"max",bgThreshold:.22,fillFloor:.15,fillDensity:.38,trim:!0,scale:.9},dR="/shivam.png",Vv={context:"name",luma:"rec709",threshold:.15,gamma:1,trim:!0,trimThreshold:.35,fit:"contain",scale:.94,solidGlyph:">",solidAbove:.5},hR={...Vv,threshold:.48,gamma:1,trimThreshold:.48,scale:.74,solidAbove:.5},jo={collapse:480,expand:920,name:2700,exit:6500,fall:1100},tv=900,pR=({onComplete:s})=>{const t=Be.useRef(null),i=Be.useRef(null),r=Be.useRef(s);r.current=s,Be.useEffect(()=>{const c=i.current,d=t.current;if(!c||!d)return;const h=window.matchMedia("(prefers-reduced-motion: reduce)").matches,p=window.matchMedia("(pointer: coarse)").matches?"TAP":"CLICK";if(h){const de=window.setTimeout(()=>r.current(),200);return()=>window.clearTimeout(de)}const _=$A({element:c});let g="idle",v=performance.now(),y=[],b=null,T=null,M=[],x={x:.5,y:.5},I=.5,U=.5,N=0,D=performance.now(),O=0,L=[],z=!1;const A=de=>de-v,C=de=>{g=de,v=performance.now(),d.dataset.phase=de},H=(de,be)=>{L.push(window.setTimeout(de,be))},J=()=>{L.forEach(de=>window.clearTimeout(de)),L=[]},q=de=>{if(!de.length)return{x:.5,y:.5};let be=0,Q=0;for(const ae of de)be+=ae.x,Q+=ae.y;return{x:be/de.length,y:Q/de.length}},ne=()=>b?sR(_,b,fR):iR(_),$=()=>{if(!T)return oR(_,"SHIVAM");const de=window.innerWidth<960||window.innerHeight<600;return rR(_,T,de?hR:Vv)},B=()=>{if(A(performance.now())<ev*.75)return null;const de=rl(Math.floor(I*_.cols)+2,0,_.cols-p.length),be=rl(Math.floor(U*_.rows),0,_.rows-1);return _.createText({text:p,col:de,row:be,context:"ui"})},G=de=>{g==="idle"&&(x=_.pixelToNormalized(window.innerWidth/2,window.innerHeight/2),M=y.map(be=>_.createPoint({x:be.x,y:be.y,value:be.value})),C("ripple"),H(()=>{C("collapse");const be=q(y);for(const Q of y)Q.homeX=be.x,Q.homeY=be.y,Q.vx+=(be.x-Q.x)*.12,Q.vy+=(be.y-Q.y)*.12},jo.collapse),H(()=>{C("wings"),y=_.morph(y,ne(),{duration:660,ease:"out",match:"radial"})},jo.expand),H(()=>{C("name"),y=_.morph(y,$(),{duration:900,match:"scan"})},jo.name),H(te,jo.exit))},te=()=>{if(!(g==="exit"||g==="done")){J(),C("exit");for(const de of y)de.morph=null,de.vx=(Math.random()-.5)*.4,de.vy=-.12-Math.random()*.3;H(()=>{g="done",d.dataset.done="true",H(()=>{z||r.current()},tv)},jo.fall)}},ve=de=>{const be=Math.min((de-D)/1e3,.033);D=de;const Q=de;switch(g){case"idle":y=eR(_,{elapsed:A(Q),mouseX:I,startupReveal:ev}),_.render(y,B());return;case"ripple":y=tR(_,{source:M,click:x,elapsed:A(Q),duration:cR}),_.render(y);return;case"collapse":_.applyPhysics(y,be,{spring:.55,friction:.5}),_.render(y);return;case"wings":case"name":{y=_.applyMorph(y,Q).points,_.render(y);return}case"exit":_.applyFall(y,be,{gravity:1.8}),_.render(y);return;default:return}},ge=de=>{N=requestAnimationFrame(ge),!(de-O<1e3/lR)&&(O=de,ve(de))},F=()=>_.measure(),ie=de=>{I=de.clientX/window.innerWidth,U=de.clientY/window.innerHeight},_e=()=>G();return window.addEventListener("resize",F),window.addEventListener("pointermove",ie),d.addEventListener("click",_e),(async()=>{_.measure();const[de,be]=await Promise.all([$_(uR).catch(()=>null),$_(dR).catch(()=>null)]);z||(b=de,T=be,C("idle"),N=requestAnimationFrame(ge))})(),()=>{z=!0,J(),cancelAnimationFrame(N),window.removeEventListener("resize",F),window.removeEventListener("pointermove",ie),d.removeEventListener("click",_e)}},[]);const l=c=>{c.stopPropagation(),t.current&&(t.current.dataset.done="true"),window.setTimeout(()=>r.current(),tv)};return j.jsxs("div",{ref:t,className:"ai-intro","data-phase":"idle",children:[j.jsx("div",{ref:i,className:"ai-grid","aria-hidden":"true"}),j.jsx("button",{className:"ai-skip",type:"button",onClick:l,children:"Skip intro"})]})},mR=()=>{const s=Be.useRef(null),t=Be.useRef({x:-100,y:-100}),i=Be.useRef({x:-100,y:-100}),r=Be.useRef(0);return Be.useEffect(()=>{const l=d=>{t.current={x:d.clientX,y:d.clientY}};window.addEventListener("mousemove",l);const c=()=>{const d=t.current.x-i.current.x,h=t.current.y-i.current.y;i.current.x+=d*.15,i.current.y+=h*.15,s.current&&(s.current.style.transform=`translate3d(${i.current.x}px, ${i.current.y}px, 0) translate(-50%, -50%)`),r.current=requestAnimationFrame(c)};return c(),()=>{window.removeEventListener("mousemove",l),cancelAnimationFrame(r.current)}},[]),j.jsx("div",{ref:s,"aria-hidden":"true",className:"custom-block-cursor blink-cursor fixed top-0 left-0 pointer-events-none z-[9999] mix-blend-difference will-change-transform",style:{boxShadow:"0 0 8px rgba(255,255,255,0.55)"}})},gR=()=>j.jsx("div",{className:"fixed inset-0 z-[90] pointer-events-none opacity-[0.035] mix-blend-overlay will-change-transform",style:{transform:"translate3d(0,0,0)",backfaceVisibility:"hidden"},children:j.jsxs("svg",{className:"w-full h-full",children:[j.jsx("filter",{id:"noiseFilter",children:j.jsx("feTurbulence",{type:"fractalNoise",baseFrequency:"0.80",numOctaves:"3",stitchTiles:"stitch"})}),j.jsx("rect",{width:"100%",height:"100%",filter:"url(#noiseFilter)"})]})}),_R=()=>j.jsxs("div",{className:"crt-root","aria-hidden":"true",children:[j.jsx("div",{className:"crt-layer crt-grid"}),j.jsx("div",{className:"crt-layer crt-scanlines"}),j.jsx("div",{className:"crt-layer crt-vignette"}),j.jsx("div",{className:"crt-layer crt-glare"})]}),vR=()=>{const[s,t]=Be.useState(!0);return j.jsxs(j.Fragment,{children:[j.jsx(mR,{}),j.jsx(gR,{}),j.jsx(_R,{}),s&&j.jsx(pR,{onComplete:()=>t(!1)}),j.jsxs("div",{className:"relative w-full min-h-screen",children:[j.jsx(yA,{}),j.jsx(WA,{})]})]})},kv=document.getElementById("root");if(!kv)throw new Error("Could not find root element to mount to");const xR=ry.createRoot(kv);xR.render(j.jsx(QS.StrictMode,{children:j.jsx(vR,{})}));
